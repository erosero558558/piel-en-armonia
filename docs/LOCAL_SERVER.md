...
- `AURORADERM_OPERATOR_AUTH_CHALLENGE_TTL_SECONDS`
- `AURORADERM_OPERATOR_AUTH_SESSION_TTL_SECONDS`
- `AURORADERM_OPERATOR_AUTH_BRIDGE_MAX_SKEW_SECONDS`
