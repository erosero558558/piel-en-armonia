...
| Formulario HCU de solicitud de imagenologia (`HCU-form.012A/2008`) | Instructivo MSP octubre 2020 | Solicitud formal de imagenologia cuando aplique | `imagingOrders[]`, `activeImagingOrder`, `documents.imagingOrders[]`, `documents.imagingReports[]`, `legalReadiness.hcu012AStatus`, `legalReadiness.hcu012AReportStatus` | P1 | Parcial: emision/cancelacion y resultado radiologico recibido trazables, con gate clinico por orden requerida; siguen diferidos integracion externa, firma avanzada y PDF literal MSP |
