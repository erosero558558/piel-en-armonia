...
| Formulario HCU de interconsulta (`HCU-form.007/2008`) | Instructivo MSP octubre 2020 | La interconsulta entra como documento/accion clinica separada del chat | `ClinicalEncounter`, `interconsultations[]`, `documents.interconsultForms[]` | P1 | Parcial: emision trazable lista; informe/respuesta del consultado sigue diferido |
