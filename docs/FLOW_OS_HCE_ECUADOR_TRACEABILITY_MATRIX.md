...
- `HCU-form.007` ya cubre de forma parcial la emision y la recepcion estructurada del informe del consultado; siguen pendientes el portal externo y la orden `HCU-form.012A`;
