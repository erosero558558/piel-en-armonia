...
/**
 * OpenclawPrescriptionFacade — Facade para prescripciones, medicación e interacciones clínicas.
 *
 * Se extrajo de OpenclawController (S42-05) para separar el dominio farmacológico del ciclo de vida
 * base de telemedicina. Todas las reglas de negocio canónicas se preservan 1:1.
 */
class OpenclawPrescriptionFacade
{
