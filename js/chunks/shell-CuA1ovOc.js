...
function q() {
    return s({
        ...
        onModuleReady: (e) =>
            e.init({
                getChatHistory: () => y.chatHistory,
                setChatHistory: (e) => {
                    y.chatHistory = e;
                },
                getConversationContext: () => y.conversationContext,
                setConversationContext: (e) => {
                    y.conversationContext = e;
                },
...
function Q() {
    return s({
        ...
        onModuleReady: (t) =>
            t.init({
                getChatbotOpen: () => y.chatbotOpen,
                setChatbotOpen: (e) => {
                    y.chatbotOpen = e;
                },
                getChatHistoryLength: () => y.chatHistory.length,
                warmChatUi: () => e(q, () => {}),
                scrollToBottom: U,
                trackEvent: v,
                debugLog: b,
