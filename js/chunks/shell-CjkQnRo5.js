...
const S = g(
    ...
    D = g('/js/engines/chat-engine.js?v=figo-chat-20260223-openclaw-queue1');
function L(e) {
    if (
        window.Piel &&
...
function O(e) {
    return t(q, (t) => t.addUserMessage(e));
}
function R(t, o = !1) {
    return e(q, (e) => e.addBotMessage(t, o));
}
function K() {
    e(q, (e) => e.showTypingIndicator());
}
function N() {
    e(q, (e) => e.removeTypingIndicator());
}
function q() {
    return s({
...
function z() {
    const e = n(() => q(), { markWarmOnSuccess: !0 });
    (i('#chatbotWidget .chatbot-toggle', 'mouseenter', e),
        i('#chatbotWidget .chatbot-toggle', 'touchstart', e),
        i('#chatInput', 'focus', e, !1),
        a(e, { idleTimeout: 2600, fallbackDelay: 1300 }));
}
function Q() {
    return s({
...
function V() {
    e(
        ...
        () => {
            ...
            if (!e) return;
            const t = !r();
            (c(t), e.classList.toggle('active', t));
        }
    );
}
function _() {
    e(
        ...
        () => {
            const e = document.getElementById('chatbotContainer');
            (e && e.classList.remove('active'), c(!1));
        }
    );
}
function G(t) {
...
async function J() {
    return e(
        ...
        async () => {
            ...
            t &&
                (await Promise.resolve(O(t)).catch(() => {}),
                (e.value = ''),
                await re(t));
        }
    );
...
function X(t) {
    e(
        Q,
        (e) => e.sendQuickMessage(t),
        () => {
            if ('appointment' === t)
                return (
                    Promise.resolve(O('Quiero agendar una cita')).catch(
                        () => {}
                    ),
                    void ee()
                );
            ...
            (Promise.resolve(O(e)).catch(() => {}), re(e));
        }
    );
}
function Y() {
    e(Q, (e) => e.scheduleInitialNotification(3e4));
}
function Z() {
    return s({
        ...
        onModuleReady: (e) =>
            e.init({
                addBotMessage: R,
                addUserMessage: O,
                showTypingIndicator: K,
                removeTypingIndicator: N,
                loadAvailabilityData: x,
                getBookedSlots: W,
                startCheckoutSession: T,
                setCheckoutStep: A,
                completeCheckoutSession: B,
                createAppointmentRecord: M,
                getCaptchaToken: I,
                showToast: o,
                trackEvent: v,
                escapeHtml: L,
...
function $() {
    ...
    (i('#chatbotWidget .chatbot-toggle', 'mouseenter', e),
        ...
        i('#chatInput', 'focus', e, !1),
        a(e, { idleTimeout: 2600, fallbackDelay: 1700 }));
}
function ee() {
    e(
        Z,
...
function te(t) {
    e(
        Z,
        (e) => e.handleChatBookingSelection(t),
        () => {
            R('No pude procesar esa opcion. Intenta nuevamente.');
        }
    );
}
function oe(t) {
    t &&
        e(
            Z,
            (e) => e.handleChatDateSelect(t),
            () => {
                R('No pude procesar esa fecha. Intenta nuevamente.');
            }
        );
}
function ne(e) {
    return t(Z, (t) => t.processChatBookingStep(e));
}
function ie() {
    return t(Z, (e) => e.finalizeChatBooking());
}
function ae() {
    return (
        !(
        ...
        onModuleReady: (e) => {
            e &&
                ...
                e.init({
                    ...
                    addBotMessage: R,
                    startChatBooking: ee,
                    processChatBookingStep: ne,
                    isChatBookingActive: ae,
                    showToast: o,
                    getConversationContext: w,
                    setConversationContext: C,
                    getCurrentAppointment: f,
                    getChatHistory: m,
                    setChatHistory: p,
                    chatContextMaxItems: 24,
                    clinicAddress: h,
                    clinicMapUrl: l,
                    doctorCarolinaPhone: d,
                    doctorCarolinaEmail: u,
                });
        },
...
function ce() {
    const e = n(() => se(), { markWarmOnSuccess: !0 });
    (i('#chatbotWidget .chatbot-toggle', 'mouseenter', e),
        i('#chatbotWidget .chatbot-toggle', 'touchstart', e),
        i('#chatInput', 'focus', e),
        a(e, { idleTimeout: 7e3, fallbackDelay: 7e3 }));
}
async function re(t) {
    return e(
        se,
        (e) => e.processWithKimi(t),
        (e) => {
            (N(),
                R(
...
export {
    R as addBotMessage,
    O as addUserMessage,
    ge as checkServerEnvironment,
    L as escapeHtml,
    ie as finalizeChatBooking,
    te as handleChatBookingSelection,
    oe as handleChatDateSelect,
    G as handleChatKeypress,
    $ as initChatBookingEngineWarmup,
    ce as initChatEngineWarmup,
    z as initChatUiEngineWarmup,
    F as initChatWidgetEngineWarmup,
    ae as isChatBookingActive,
    Z as loadChatBookingEngine,
    q as loadChatUiEngine,
    Q as loadChatWidgetEngine,
    se as loadFigoChatEngine,
    _ as minimizeChatbot,
    ne as processChatBookingStep,
    re as processWithKimi,
    N as removeTypingIndicator,
    Y as scheduleChatNotification,
    U as scrollToBottom,
    J as sendChatMessage,
    X as sendQuickMessage,
    K as showTypingIndicator,
    ee as startChatBooking,
    V as toggleChatbot,
};
