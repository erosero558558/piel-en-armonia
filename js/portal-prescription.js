(function (window, document) {
    ...
    function renderSummary(prescription) {
        ...
        return `
            ...
            <div class="disclaimer disclaimer--prescription">
                ...
                <div class="disclaimer-content">
                    <strong>Uso de receta</strong>
                    <p style="margin:0">Este documento no equivale a una promesa de curaci&oacute;n. Siga las instrucciones exactas y asista a su control programado.</p>
                </div>
            </div>
        `;
    }
