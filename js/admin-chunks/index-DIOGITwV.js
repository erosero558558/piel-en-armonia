...
function Fe(e, t = 0, a = {}) {
    const n = e && 'object' == typeof e ? e : {},
        i = Ue({ ...n, ...a }, t);
    return (
        De(n.createdAt, n.created_at) || (i.createdAt = ''),
        De(n.priorityClass, n.priority_class) || (i.priorityClass = ''),
        De(n.queueType, n.queue_type) || (i.queueType = ''),
        De(n.patientInitials, n.patient_initials) || (i.patientInitials = ''),
        i
    );
}
function Ke(e, t, a) {
...
function ze(e, t, a) {
    return e ? Fe(e, t, { status: 'called', assignedConsultorio: a }) : null;
}
function Ve(e, t = []) {
    const a = e && 'object' == typeof e ? e : {},
        ...
        { c1: r, c2: l } = (function (e, t) {
            return { c1: ze(Ke(e, t, 1), 0, 1), c2: ze(Ke(e, t, 2), 1, 2) };
        })(i, o),
        c = (function (e) {
...
function We(e) {
    const t = Ue(e, 0);
    return t.id > 0 ? `id:${t.id}` : `code:${Ne(t.ticketCode || '')}`;
}
function Je(e, t) {
    if (!t) return;
    const a = Ue(t, e.size);
    (De(t?.createdAt, t?.created_at) || (a.createdAt = ''),
        De(t?.priorityClass, t?.priority_class) || (a.priorityClass = ''),
        De(t?.queueType, t?.queue_type) || (a.queueType = ''),
        e.set(We(a), a));
}
function Ye(e) {
    const t = Ve(e),
        ...
        i =
            ...
            t.callingNowByConsultorio?.[2] ||
            null;
    (n && Je(a, { ...n, status: 'called', assignedConsultorio: 1 }),
        i && Je(a, { ...i, status: 'called', assignedConsultorio: 2 }));
    for (const e of je(t.nextTickets))
        Je(a, { ...e, status: 'waiting', assignedConsultorio: null });
    return Array.from(a.values());
}
function Ze() {
    const e = g(),
        t = Array.isArray(e.data.queueTickets)
            ? e.data.queueTickets.map((e, t) => Ue(e, t))
            : [];
    return {
        queueTickets: t,
        queueMeta:
            e.data.queueMeta && 'object' == typeof e.data.queueMeta
                ? Ve(e.data.queueMeta, t)
                : He(t),
    };
}
function Xe() {
...
function et(e, t = null) {
    const a = Array.isArray(t) ? t : Ze().queueTickets,
...
function tt() {
    return et(g().queue.selected || []);
}
function at() {
    const e = (function () {
        const e = new Set(tt());
        return e.size
            ? Ze().queueTickets.filter((t) => e.has(Number(t.id || 0)))
            : [];
    })();
    return e.length ? e : Xe();
}
function nt(e) {
    const t = Number(e || 0);
    return (
        (t && Ze().queueTickets.find((e) => Number(e.id || 0) === t)) || null
    );
}
function it(e) {
...
function rt(t) {
    const a = t.assignedConsultorio ? `C${t.assignedConsultorio}` : '-',
        n = Math.max(0, Math.round((Date.now() - Re(t.createdAt)) / 6e4)),
        i = Number(t.id || 0),
        o = new Set(tt()).has(i),
        s = 'called' === t.status,
...
const lt = Object.freeze({
    ...
    dt = 'queueInstallPresetV1',
    pt = 'queueOpeningChecklistV1',
    mt = 'queueShiftHandoffV1',
    gt = 'queueOpsLogV1',
    bt = 'queueOpsLogFilterV1',
    yt = 'queueOpsAlertsV1',
    ft = 'queueOpsFocusModeV1',
    vt = 'queueOpsPlaybookV1',
    ht = 'queueTicketLookupV1',
    kt = Object.freeze([
        'operator_ready',
        'kiosk_ready',
        'sala_ready',
...
function Pt(e) {
    ...
    try {
        Mt
            ? window.localStorage.setItem(ht, Mt)
            : window.localStorage.removeItem(ht);
    } catch (e) {}
    return Mt;
}
function jt() {
    if ('string' == typeof Mt) return Mt;
    const e = It(g().queue.search);
    return (
        (Mt =
            (function () {
                try {
                    return It(window.localStorage.getItem(ht) || '');
                } catch (e) {
                    return '';
                }
            })() || e),
...
function Ht() {
    Bt.settleTimerId &&
        (window.clearTimeout(Bt.settleTimerId), (Bt.settleTimerId = 0));
}
function Ut() {
    if ((Ht(), Bt.pendingManifest)) return void Ot();
    if (!Kt()) return void Ot();
    const e = Math.max(80, 900 - Ft());
    Bt.settleTimerId = window.setTimeout(() => {
        ((Bt.settleTimerId = 0),
            Bt.pendingManifest ? Ot() : Kt() ? Ut() : Ot());
    }, e);
}
function Ft() {
    return Bt.lastAt
        ? Math.max(0, Date.now() - Bt.lastAt)
...
function zt() {
    (Bt.timerId && (window.clearTimeout(Bt.timerId), (Bt.timerId = 0)),
        (Bt.pendingManifest = null),
        (Bt.pendingPlatform = ''),
        Ot(),
        Ut());
}
function Vt(e, t) {
    ((Bt.pendingManifest = e),
        (Bt.pendingPlatform = t),
        Bt.timerId && window.clearTimeout(Bt.timerId),
        Ht(),
        Ot());
    const a = Math.max(80, 900 - Ft());
    Bt.timerId = window.setTimeout(() => {
        !(function () {
            const e = Bt.pendingManifest,
                t = Bt.pendingPlatform;
            ((Bt.timerId = 0),
                e
                    ? Kt()
                        ? Vt(e, t)
...
function Gt(e) {
    return `https://api.qrserver.com/v1/create-qr-code/?size=360x360&data=${encodeURIComponent(Qt(e))}`;
}
function Wt(e, t, a) {
    const n = new URL(
...
function Zt(e) {
    ...
    const t = (function (e) {
        try {
            const t = window.localStorage.getItem(dt);
            return t ? Jt(JSON.parse(t), e) : null;
        } catch (e) {
            return null;
        }
    })(e);
...
function aa(e = ta()) {
    return { date: e, steps: kt.reduce((e, t) => ((e[t] = !1), e), {}) };
}
function na(e) {
    const t = ta(),
...
function ia(e) {
    _t = na(e);
    try {
        localStorage.setItem(pt, JSON.stringify(_t));
    } catch (e) {}
    return _t;
}
function oa() {
        ...
        (_t && _t.date === e) ||
            (_t = (function () {
                ...
                try {
                    ...
                    return String(a?.date || '') !== e ? aa(e) : na(a);
                } catch (t) {
                    return aa(e);
                }
            })()),
...
function sa(e) {
    const t = oa(),
        a = (Array.isArray(e) ? e : []).filter((e) => kt.includes(e));
...
function ra(e = ta()) {
    return { date: e, steps: qt.reduce((e, t) => ((e[t] = !1), e), {}) };
}
function la(e) {
    const t = ta(),
        a = e && 'object' == typeof e ? e : {};
...
function ca(e) {
    Ct = la(e);
    try {
        localStorage.setItem(mt, JSON.stringify(Ct));
    } catch (e) {}
    return Ct;
}
function ua() {
        ...
        (Ct && Ct.date === e) ||
            (Ct = (function () {
                ...
                try {
                    ...
                    if (!t) return ra(e);
                    const a = JSON.parse(t);
                    return String(a?.date || '') !== e ? ra(e) : la(a);
                } catch (t) {
                    return ra(e);
                }
            })()),
...
function da(e) {
    const t = ua(),
        a = (Array.isArray(e) ? e : []).filter((e) => qt.includes(e));
    if (!a.length) return t;
    const n = { ...t.steps };
    return (
        a.forEach((e) => {
...
function ba(e) {
    St = ga(e);
    try {
        localStorage.setItem(gt, JSON.stringify(St));
    } catch (e) {}
    return St;
}
function ya() {
        ...
        (St && St.date === e) ||
            (St = (function () {
                ...
                try {
                    ...
                    if (!t) return pa(e);
                    const a = JSON.parse(t);
                    return String(a?.date || '') !== e ? pa(e) : ga(a);
                } catch (t) {
                    return pa(e);
                }
            })()),
...
function fa(e) {
    const t = ya(),
        a = ma({ ...e, createdAt: e?.createdAt || new Date().toISOString() }),
        n = t.items[0];
    ...
    return ba({ ...t, items: [a, ...t.items].slice(0, 24) });
}
function va(e) {
        ...
        (Lt && Lt.date === e) ||
            (Lt = (function () {
                ...
                try {
                    ...
                    if (!t) return ha(e);
                    const a = JSON.parse(t);
                    return String(a?.date || '') !== e ? ha(e) : ka(a);
                } catch (t) {
                    return ha(e);
                }
            })()),
...
function wa(e) {
    Tt = Sa(e);
    try {
        localStorage.setItem(vt, JSON.stringify(Tt));
    } catch (e) {}
    return Tt;
}
function La() {
        ...
        (Tt && Tt.date === e) ||
            (Tt = (function () {
                ...
                try {
                    ...
                    if (!t) return Ca(e);
                    const a = JSON.parse(t);
                    return String(a?.date || '') !== e ? Ca(e) : Sa(a);
                } catch (t) {
                    return Ca(e);
                }
            })()),
...
function xa(e) {
    const t = g(),
        ...
        n = oa(),
        o = ua(),
        s = kt.filter((e) => n.steps[e]).length,
        r = qt.filter((e) => o.steps[e]).length,
        l = Ia('operator'),
        c = Ia('kiosk'),
        u = Ia('display'),
        d = Ja(),
    ...
    return [
        ...
        b.trim(),
        y.trim(),
        `Apertura confirmada: ${s}/${kt.length}.`,
        `Cierre confirmado: ${r}/${qt.length}.`,
        `Perfil actual operador: ${'c2' === Zt(e).station ? 'C2' : 'C1'}${Zt(e).lock ? ' fijo' : ' libre'}.`,
    ].join('\n');
}
function Ra(e, t) {
    const a = Ja(),
...
async function Oa(e) {
    try {
        (await navigator.clipboard.writeText(xa(e)),
...
function Ha(e, t) {
    const a = oa(),
        ...
        i = Pa(t),
        o = Ja(),
        s = [Va('operator'), Va('kiosk'), Va('display')],
            ...
            : l > 0
              ...
              : c.length > 0
                ...
                : ((m = 'ready'),
                  ...
                  (v = {
                      kind: 'anchor',
                      href: Ma('operator', e.operator || lt.operator, {
                          ...Zt(t),
                      }),
        ...
        (i.onclick = () => {
            ...
            e.suggestedIds.length &&
                ...
                fa({
                    ...
                    summary: `Se confirmaron pasos de apertura ya validados por telemetría. Perfil activo: ${Xt(a)}.`,
                }),
                nn(t, a),
                fi(t, a),
                ki(t, a),
...
function za(e, t = 'Sin heartbeat reciente') {
    const a = Number(e?.ageSec);
    return Number.isFinite(a) ? `Heartbeat hace ${Ka(a)}` : t;
}
function Va(e) {
    const t = (function () {
...
function Ga(e, t) {
    ...
    return [
        {
            key: 'operator',
            appConfig: e.operator || lt.operator,
            fallbackSurface: 'operator',
            actionLabel: 'Abrir operador',
        },
        {
            key: 'kiosk',
            appConfig: e.kiosk || lt.kiosk,
            fallbackSurface: 'kiosk',
            actionLabel: 'Abrir kiosco',
        },
        {
            key: 'display',
            appConfig: e.sala_tv || lt.sala_tv,
        ...
        const t = Va(e.key),
            ...
            o =
                ...
                ut[e.key]?.emptySummary ||
                'Sin señal todavía.',
            s = Ma(e.fallbackSurface, e.appConfig, {
                ...a,
                surface: e.fallbackSurface,
            });
        return {
            key: e.key,
            title: ut[e.key]?.title || e.key,
            state:
...
function Ya() {
    ...
    const { queueMeta: t } = Ze(),
        a = Date.parse(String(t?.updatedAt || '')),
        n = Number.isFinite(a)
            ? `Ultima cola actualizada hace ${Ka(Math.max(0, Math.round((Date.now() - a) / 1e3)))}`
...
function Za(e, t) {
    const a = Zt(t),
        ...
        i = Ma('operator', e.operator || lt.operator, { ...a }),
        { group: o, latest: s, details: r } = Ia('operator'),
        l = String(r.station || '')
            .trim()
            .toLowerCase(),
...
function Xa(e, t) {
    const a = Zt(t),
        n = Ma('kiosk', e.kiosk || lt.kiosk, { ...a }),
        { group: i, latest: o, details: s } = Ia('kiosk'),
...
function en(e, t) {
    const a = Zt(t),
        n = Ma('sala_tv', e.sala_tv || lt.sala_tv, { ...a }),
        { group: i, latest: o, details: s } = Ia('display'),
        r = String(s.connection || 'live')
            .trim()
            .toLowerCase(),
        l = za(o);
        ...
        (s.onclick = () => {
            ...
            e.length &&
                ...
                fa({
                    ...
                    summary: `Se marcaron como revisadas las alertas visibles del turno. Perfil activo: ${Xt(a)}.`,
                }),
                tn(t, a),
                Ci(t, a));
        }),
...
function an(e, t) {
    const a =
            (At ||
                (At = (function () {
                    try {
                        return _a(localStorage.getItem(ft));
                    } catch (e) {
                        return 'auto';
                    }
                })()),
        ...
        i = Ja(),
        o = kt.length - kt.filter((e) => oa().steps[e]).length,
        s = qt.length - qt.filter((e) => ua().steps[e]).length,
        r = Va('operator'),
        l = Va('kiosk'),
        c = Va('display'),
        u =
        ...
        d = Boolean(ja().suggestions.queue_clear?.suggested),
        p = u
            ? 'incidents'
            : o > 0
              ? 'opening'
...
function rn(e, t, a) {
    const n = 'C' + (2 === Number(e.queue.stationConsultorio || 1) ? 2 : 1),
        i = on(e.queue.pendingSensitiveAction, t);
    return [
        {
            id: 'enter',
            keyLabel: 'Enter',
...
function ln(t, a) {
    ...
    const n = (function (e, t) {
        const a = g(),
            ...
            s = st(),
            r = ot(n),
            l = on(a.queue.pendingSensitiveAction, s),
            c = (function (e) {
            ...
            y = Zt(t),
            f = Ma('operator', e.operator || lt.operator, {
                ...y,
                station: 2 === n ? 'c2' : 'c1',
...
function cn(e, t) {
    ...
    return 'called' === t ? `llamado hace ${Ka(n)}` : `espera hace ${Ka(n)}`;
}
function un(e, t = 'waiting') {
    const a = dn(e, t);
    return Number.isFinite(a)
        ? Math.max(0, Math.round((Date.now() - a) / 1e3))
        : null;
}
function dn(e, t = 'waiting') {
...
function gn() {
    return pn().filter((e) => !Number(e.assignedConsultorio || 0));
}
function bn(e) {
    const t = 2 === Number(e || 0) ? 2 : 1;
    return pn().filter((e) => Number(e.assignedConsultorio || 0) === t);
}
function yn(e, t) {
    const a = 2 === Number(t || 0) ? 2 : 1;
    return mn(e).filter((e) => Number(e.assignedConsultorio || 0) === a);
}
function fn(e, t) {
    const a = 2 === Number(t || 0) ? 2 : 1;
    return (
...
function kn(e, t, a) {
    ...
    return {
        ...
        operatorLive: c,
        operatorLabel: u,
        operatorUrl: Ma('operator', e.operator || lt.operator, {
            ...Zt(t),
            station: i,
            lock: !0,
        }),
        ...
        numpadLabel: l
            ? o.details.numpadSeen
                ...
                : 'Numpad pendiente'
            : 'Numpad sin señal',
        heartbeatLabel: za(o.latest, 'Sin heartbeat'),
    };
}
function qn(t, a) {
    if (
                ...
                (function (e, t, a) {
                    ...
                    return (
                                    ...
                                    (h = 'open')),
                        {
                            ...
                            summary: f,
                            currentLabel: m
                                ? `${m.ticketCode} · ${cn(m, 'called')}`
                                : 'Sin llamado',
                            nextLabel: g
                                ? `${g.ticketCode} · ${cn(g, 'waiting')}`
...
function Cn(t, a) {
        ...
        const a = [1, 2].map((a) =>
                (function (e, t, a) {
                    const n = kn(e, t, a),
                        ...
                        y = gn().length,
                        f = (m && un(m, 'called')) || 0,
                        v = m ? cn(m, 'called') : 'sin llamado activo';
                    let h = 'idle',
    ...
    (l(
        ...
        n.cards.forEach((e) => {
            ...
            n instanceof HTMLButtonElement &&
                (n.onclick = async () => {
                    ((n.disabled = !0), await _n(e, e.primaryAction, t, a));
                });
            ...
            i instanceof HTMLButtonElement &&
                (i.onclick = async () => {
                    ((i.disabled = !0), await _n(e, 'complete', t, a));
                });
            ...
            o instanceof HTMLButtonElement &&
                (o.onclick = async () => {
                    ((o.disabled = !0), await _n(e, 'release', t, a));
                });
        }));
}
function Sn(e, t, a = '') {
        ...
        try {
            ...
            if ('complete' === t && e.currentTicketId > 0)
                ...
                (await o(e.currentTicketId, 'no_show', e.slot),
                    g().queue.pendingSensitiveAction && sn());
            else if ('release' === t && e.currentTicketId > 0)
                ...
                ...Sn(
                    ...
                    'no_show' === t
                        ? on(
                              ...
                              nt(e.currentTicketId)
                          )
                        : on(g().queue.pendingSensitiveAction)
                ),
            });
        } catch (e) {
...
function Ln(t, a) {
            ...
            n = [1, 2].map((a) =>
                (function (e, t, a) {
                    const n = g(),
                        ...
                        y = b ? on(m, u) : '',
                        f = u ? cn(u, 'called') : 'sin llamado activo',
    ...
    (l(
        ...
        n.cards.forEach((e) => {
            ...
            i instanceof HTMLButtonElement &&
                (i.onclick = async () => {
                    ((i.disabled = !0), await wn(e, 'no_show', t, a));
                });
            const o = document.getElementById(
...
function Mn(e, t) {
    ...
    const a = An(e?.ticketCode),
        n = An(e?.patientInitials),
        i = An(e?.queueType),
        o = An(e?.status),
...
function Bn(e, t, a) {
    ...
    const n = Number(e.assignedConsultorio || 0),
        ...
        p = Number(d?.ticketId || 0) === Number(e.id || 0) ? on(d, e) : '';
    let m = `${o} localizado`,
    ...
    const $ = [],
        ...
        S =
            i > 0
                ? Ma('operator', t.operator || lt.operator, {
                      ...Zt(a),
                      station: 2 === i ? 'c2' : 'c1',
                      lock: !0,
                  })
    ...
    const a = jt(),
        n = a
            ? (function (e, t = 4) {
                  ...
                  return [...Ze().queueTickets]
                      .map((e) => ({ ticket: e, score: Mn(e, a) }))
            ...
            : [],
        i = n[0] ? Bn(n[0], e, t) : null,
        o = (
            a
                ? n.slice(1)
                : (function (e = 4) {
                      const t = [it(1), it(2), gn()[0] || null, ot(1), ot(2)],
                          a = new Set();
                      return t
                          .filter((e) => {
...
function Pn(t, a) {
    ...
    const o = document.getElementById('queueTicketLookupInput'),
        ...
        u = () => {
            (Pt(o instanceof HTMLInputElement ? o.value : i.term), Si(t, a));
        };
    (o instanceof HTMLInputElement &&
        (o.onkeydown = (e) => {
            'Enter' === e.key
                ...
                : 'Escape' === e.key &&
                  o.value &&
                  (e.preventDefault(), (o.value = ''), Pt(''), Si(t, a));
        }),
        ...
        n
            ...
            .forEach((e) => {
                e instanceof HTMLButtonElement &&
                    (e.onclick = () => {
                        (Pt(e.dataset.queueTicketLookupSuggestion || ''),
                            Si(t, a));
                    });
            }),
...
function Rn(t, a) {
    ...
    const n = (function (e, t) {
        ...
        const i = (function (e = '') {
                ...
                if (!t) return null;
                const a = It(e);
                if (!a || a !== t.lookupTerm) return xt();
                const n = nt(t.sourceTicketId),
                    i = String(n?.status || '')
                        .trim()
                        .toLowerCase(),
            ...
            o = Array.isArray(i?.tickets)
                ? i.tickets.map(Rt).filter(Boolean)
                : Ze().queueTickets.map(Rt).filter(Boolean),
            s = o.map(Rt).filter(Boolean),
            r =
                (function (e, t) {
                    const a = Number(t || 0);
                    return (
        ...
        const l = String(r.status || '')
            ...
            f = mn(o).filter((e) => !Number(e.assignedConsultorio || 0)),
            v = p > 0 ? yn(o, p) : f,
            ...
            (Pt(n.focusPivot.ticketCode),
                Array.isArray(n.projectedTickets) &&
                    (function (e) {
                        ...
                        sourceStatus: nt(n.result.ticketId)?.status,
...
function Dn(e, t, a) {
    ...
    p
        ? u.push({
              ...
              support: `${cn(p, 'waiting')}. Quedará detrás del primer llamado del carril.`,
              pivot: jn(
                  p,
                  `Cargar ${p.ticketCode}`,
...
function On(e, t) {
    const a = gn(),
        n = { 1: kn(e, t, 1), 2: kn(e, t, 2) },
        i = {
            1: bn(1).length + (it(1) ? 1 : 0),
            2: bn(2).length + (it(2) ? 1 : 0),
        },
        o = a.slice(0, 3).map((a, o) => {
            const s = (function (e, t, a, n) {
                    return [1, 2]
                        .map((i) => {
                            const o = n[i] || kn(e, t, i),
                                s = Boolean(
...
function Hn(e, t) {
    const a = [Dn(e, t, 1), Dn(e, t, 2), On(e, t)],
                ...
                (function (e, t, a) {
                    ...
                    let g = 'idle',
                        ...
                        f = r
                            ...
                            : 'Sin paciente en atención',
                        v = c
                            ? `${c.ticketCode} · ${cn(c, 'waiting')}`
                            : 'Sin siguiente asignado',
                        h = u
                            ? `${u.ticketCode} · ${cn(u, 'waiting')}`
                            : d
...
function Gn(t, a) {
    ...
    const o = (function (e, t) {
        const a = Hn(e, t),
            ...
            i = [];
        if (n) {
            const e = nt(Number(n.ticketId || 0)),
                t = on(n, e || null);
            e &&
                t &&
                i.push({
...
function Zn({ ageSec: e, backlog: t, operatorReady: a }) {
    ...
    const n = (function (e, t) {
                ...
                (function (e, t, a) {
                    if ('general' === a) {
                        ...
                        return (
                            ...
                            p.push(l.support),
                            {
                                ...
                                detail: c,
                                oldestLabel: `${n.ticketCode} · ${cn(n, 'waiting')}`,
                                pressureLabel: `General ${a.length} · C1 ${bn(1).length} · C2 ${bn(2).length}`,
                    ...
                    if (!c && l)
                        return {
                            ...
                            oldestLabel: `${l.ticketCode} · ${cn(l, 'called')}`,
                    ...
                    return {
                        ...
                        detail: o.detail,
                        oldestLabel: `${c.ticketCode} · ${cn(c, 'waiting')}`,
                        pressureLabel: `Propios ${s.length} · General ${r.length}`,
                        recommendationLabel: o.primaryLabel,
        ...
        return {
            ...
            chips: [
                `Acciones ${o}`,
                `Alertas ${n}`,
                s > 0 ? `Espera máxima ${Ka(s)}` : 'Espera máxima 0s',
            ],
            cards: a,
        };
    })(t, a);
...
function ti(t, a) {
    ...
    const n = (function (e, t) {
        const a = [1, 2].map((a) =>
            ...
            n = bn(1).length + (it(1) ? 1 : 0),
            i = bn(2).length + (it(2) ? 1 : 0),
            o = Math.abs(n - i),
            s = gn().length,
...
function ii(t, a) {
    if (!(document.getElementById('queuePriorityLane') instanceof HTMLElement))
        return;
    const n = (function (e, t) {
        const a = { 1: mi(e, t, 1), 2: mi(e, t, 2) },
            n = (function (e = 4) {
                return [...pn()]
                    .sort((e, t) => {
                        const a = hn(t) - hn(e);
                        if (0 !== a) return a;
                        const n = dn(e, 'waiting'),
                            i = dn(t, 'waiting');
        ...
        const e = g(),
            ...
            r = a.filter(
                (e) =>
                    ...
                    (Math.max(
                        0,
                        Math.round((Date.now() - dn(e, 'waiting')) / 6e4)
                    ) >= 20 ||
                        'appt_overdue' ===
...
function ri(e, t, a, n, i) {
    const o = String(g().queue?.filter || 'all')
        ...
        r = ai(a),
        l = vn(a),
        c = cn(a, 'called' === a?.status ? 'called' : 'waiting');
...
function li(t, a) {
    ...
    const n = (function (e, t) {
        const a = g(),
            ...
            o = Xe(),
            s = { 1: mi(e, t, 1), 2: mi(e, t, 2) },
            r = o.slice(0, 3).map((e, t) => ri(0, 0, e, t, s)),
            l = si(n),
            c = [];
...
function ui(e, t) {
    const a = g(),
        ...
        r = o.slice(0, 3).map((e, t) => ri(0, 0, e, t, s)),
        l = [];
    ('all' !== n && l.push(si(n)), i && l.push(`búsqueda "${i}"`));
    const c = l.length > 0,
        u = r.find((e) => ci(e)),
        d = u
            ? (function (e) {
...
async function di(e, t, a) {
    if (!e) return;
    if ('dispatch' === e.kind && e.actionCard)
        return void (await bi(e.actionCard, t, a, {
            source: 'tray_burst',
            deferRerender: !0,
        }));
        ...
        (o.onclick = async () => {
            ((o.disabled = !0),
                await (async function (e, t) {
                    ...
                    if (a.steps.length)
                        try {
                            for (const n of a.steps) await di(n, e, t);
                            fa({
                                tone: 'success',
                                source: 'tray_burst',
...
function fi(t, a) {
    ...
    const n = (function (e, t) {
        const a = an(e),
            n = Zt(t),
            i = e.operator || lt.operator,
            o = e.kiosk || lt.kiosk,
            s = e.sala_tv || lt.sala_tv,
            r = Ma('operator', i, { ...n }),
            l = Ma('kiosk', o, { ...n }),
            c = Ma('sala_tv', s, { ...n }),
            u = Pa(t),
            ...
            m = [
                ...
                'closing' === a.effectiveMode
                    ? `Relevo ${d.suggestedCount}/${qt.length}`
                    : `Apertura ${u.suggestedCount}/${kt.length}`,
            ];
    ...
    i instanceof HTMLButtonElement &&
        ((i.disabled = Pa(a).suggestedCount <= 0),
        (i.onclick = () => {
            const e = Pa(a);
            e.suggestedIds.length &&
                (sa(e.suggestedIds),
                fa({
                    ...
                    source: 'opening',
                    title: `Apertura: ${e.suggestedIds.length} sugerido(s) confirmados`,
                    summary: `La consola rápida confirmó sugeridos de apertura. Perfil activo: ${Xt(a)}.`,
                }),
                nn(t, a),
                fi(t, a),
                ki(t, a),
        ...
        (p.onclick = () => {
            s.suggestedIds.length &&
                ...
                fa({
                    ...
                    summary: `El checklist de apertura quedó actualizado usando telemetría reciente. Perfil activo: ${Xt(a)}.`,
                }),
                nn(t, a),
                fi(t, a),
                ki(t, a),
    ...
    const o = ya(),
        r =
            (wt ||
                (wt = (function () {
                    try {
                        return va(localStorage.getItem(bt));
                    } catch (e) {
                        return 'all';
                    }
                })()),
        ...
        u = o.items[0] || null,
        d = u
            ? `${u.title}. ${u.summary} Vista actual: ${Da(r)}.`
        ...
        `\n            <section class="queue-ops-log__shell">\n                <div class="queue-ops-log__header">\n                    <div>\n                        <p class="queue-app-card__eyebrow">Bitácora operativa</p>\n                        <h5 id="queueOpsLogTitle" class="queue-app-card__title">Bitácora operativa del día</h5>\n                        <p id="queueOpsLogSummary" class="queue-ops-log__summary">${e(d)}</p>\n                        <div class="queue-ops-log__filters" role="tablist" aria-label="Filtro de bitácora">\n                            <button\n                                id="queueOpsLogFilterAll"\n                                type="button"\n                                class="queue-ops-log__filter"\n                                data-filter="all"\n                                data-state="${'all' === r ? 'active' : 'idle'}"\n                            >\n                                Todo\n                            </button>\n                            <button\n                                id="queueOpsLogFilterIncidents"\n                                type="button"\n                                class="queue-ops-log__filter"\n                                data-filter="incidents"\n                                data-state="${'incidents' === r ? 'active' : 'idle'}"\n                            >\n                                Incidencias\n                            </button>\n                            <button\n                                id="queueOpsLogFilterChanges"\n                                type="button"\n                                class="queue-ops-log__filter"\n                                data-filter="changes"\n                                data-state="${'changes' === r ? 'active' : 'idle'}"\n                            >\n                                Cambios\n                            </button>\n                            <button\n                                id="queueOpsLogFilterStatus"\n                                type="button"\n                                class="queue-ops-log__filter"\n                                data-filter="status"\n                                data-state="${'status' === r ? 'active' : 'idle'}"\n                            >\n                                Estados\n                            </button>\n                        </div>\n                    </div>\n                    <div class="queue-ops-log__meta">\n                        <span\n                            id="queueOpsLogChip"\n                            class="queue-ops-log__chip"\n                            data-state="${e(m)}"\n                        >\n                            ${e(p)}\n                        </span>\n                        <button\n                            id="queueOpsLogStatusBtn"\n                            type="button"\n                            class="queue-ops-log__action queue-ops-log__action--primary"\n                        >\n                            Registrar estado actual\n                        </button>\n                        <button\n                            id="queueOpsLogIncidentBtn"\n                            type="button"\n                            class="queue-ops-log__action"\n                        >\n                            Registrar incidencia actual\n                        </button>\n                        <button\n                            id="queueOpsLogCopyBtn"\n                            type="button"\n                            class="queue-ops-log__action"\n                        >\n                            Copiar bitácora\n                        </button>\n                        <button\n                            id="queueOpsLogClearBtn"\n                            type="button"\n                            class="queue-ops-log__action"\n                        >\n                            Limpiar bitácora de hoy\n                        </button>\n                    </div>\n                </div>\n                <div id="queueOpsLogItems" class="queue-ops-log__list" role="list" aria-label="Bitácora operativa">\n                    ${
            c.length > 0
                ? c
                      ...
                      .join('')
                : `\n                                <article class="queue-ops-log__empty" role="listitem">\n                                    <strong>Sin eventos para este filtro</strong>\n                                    <p>No hay registros en ${e(Da(r).toLowerCase())} hoy. Cambia el filtro o registra un estado/incidencia nueva.</p>\n                                </article>\n                            `
        }\n                </div>\n            </section>\n        `
    );
            ...
            (fa(
                (function (e, t) {
                    const a = Ha(e, t),
                        ...
                        i = oa(),
                        o = ua(),
                        s = kt.filter((e) => i.steps[e]).length,
                        r = qt.filter((e) => o.steps[e]).length;
                    return {
                        tone:
                            'alert' === n.state
                        ...
                        summary: `${a.title}. Apertura ${s}/${kt.length}, cierre ${r}/${qt.length}, equipos listos ${a.readyEquipmentCount}/3, sync ${n.title.toLowerCase()}, perfil ${Xt(t)}.`,
                    };
                })(t, a)
            ),
                Ci(t, a));
    ...
    const r =
            'sala_tv' === o
                ...
                : 'mac' === i.platform
                  ? 'mac'
                  : 'win',
        c = (s.targets && s.targets[r]) || Ta(s, a) || null,
        u = Ma(o, s, i),
        d = Gt(('sala_tv' === o && c && c.url) || u),
        p = Wt(o, i, s),
        m = (function (e) {
                ...
                (e.onclick = () => {
                    ...
                    n &&
                        ...
                        fa({
                            ...
                            summary: `${Xt(a)}. El asistente ya quedó listo con este perfil.`,
                        }),
                        Si(t, a));
                });
        }));
        ...
        (b.onchange = () => {
            (Yt(
                ...
                fa({
                    ...
                    summary: `${Xt(a)}. La ruta preparada ya quedó alineada para descarga y fallback.`,
                }),
                Si(t, a));
        });
        ...
        (f.onchange = () => {
            (Yt({ ...i, oneTap: f.checked }, a),
                fa({
                    ...
                    summary: `${Xt(a)}. Ajuste guardado en el preparador de rutas operativas.`,
                }),
                Si(t, a));
        });
}
function Li(e = {}) {
    ...
    const o = 'mac' === n || 'win' === n || 'other' === n ? n : Nt(),
    ...
    !t && i && 'true' === i.dataset.queueHubReady && Kt()
        ? Vt(c, o)
        : (zt(),
          l(
              '#queueAppDownloadsCards',
              [
                  Ea('operator', c.operator, o),
                  Ea('kiosk', c.kiosk, o),
                  Ba(c.sala_tv),
              ].join('')
          ),
...
function Ai(t = () => {}) {
    const a = g(),
        ...
        o = tt(),
        s = at(),
        c = it(a.queue.stationConsultorio);
    (Li(),
        (function (e, t) {
            const a = g();
            (!(function (e) {
                ...
                (function (e) {
                    ...
                    (r('#queueC1Now', n),
                        r('#queueC2Now', i),
                        Be('queueReleaseC1', 1, t, n),
                        Be('queueReleaseC2', 2, a, i));
                })(e),
                (function (e, t, a) {
                    const n = document.getElementById('queueSyncStatus');
                    if ('fallback' === Ne(e.queue.syncMode))
                        return (
            ...
            const i = (function (e) {
                    return e.filter(
                        (e) =>
                            ...
                            (Math.max(
                                0,
                                Math.round((Date.now() - Re(e.createdAt)) / 6e4)
                            ) >= 20 ||
                                'appt_overdue' === Ne(e.priorityClass))
                    ).length;
                })(t),
...
function Mi(e, { render: t = !0 } = {}) {
    (b((t) => ({
        ...t,
        queue: { ...t.queue, selected: et(e, t.data.queueTickets || []) },
    })),
        t && Ai(Ti));
}
function Ei(e) {
    const t = Number(e || 0);
    if (!t) return;
    const a = et(g().queue.selected || []);
    Mi(a.includes(t) ? a.filter((e) => e !== t) : [...a, t]);
}
function Bi() {
    Mi(Xe().map((e) => Number(e.id || 0)));
}
function Ni() {
    Mi([]);
}
const Ii = 'queueStationMode',
    Pi = 'queueStationConsultorio',
    ji = 'queueOneTapAdvance',
    xi = 'queueCallKeyBindingV1',
    Ri = 'queueNumpadHelpOpen',
    Di = 'queueAdminLastSnapshot',
    Oi = new Map([
        [1, !1],
        [2, !1],
    ]),
    Hi = new Set(['no_show', 'cancelar']);
function Ui(e) {
    (w(Ii, e.queue.stationMode || 'free'),
        w(Pi, e.queue.stationConsultorio || 1),
        w(ji, e.queue.oneTap ? '1' : '0'),
        w(Ri, e.queue.helpOpen ? '1' : '0'),
        e.queue.customCallKey
            ? A(xi, e.queue.customCallKey)
            : (function (e) {
                  try {
...
function Fi(e, t = null, a = {}) {
    const n = (Array.isArray(e) ? e : []).map((e, t) => Ue(e, t)),
        i = Ve(t && 'object' == typeof t ? t : He(n), n),
    ...
    (b((e) => ({
        ...
        queue: {
            ...e.queue,
            selected: et(e.queue.selected || [], n),
            runtimeRevision: l
...
function zi(e) {
    (b((t) => ({ ...t, queue: { ...t.queue, ...e } })), Ui(g()), Ai(Ti));
}
function Vi(e) {
    zi({ filter: Ne(e) || 'all', selected: [] });
}
function Qi(e) {
    zi({ search: String(e || ''), selected: [] });
}
function Gi() {
    zi({ search: '', selected: [] });
...
var Wi = Object.freeze({
    ...
    appendActivity: Ti,
    clearQueueSearch: Gi,
    clearQueueSelection: Ni,
    mutateTicketLocal: Ki,
    selectVisibleQueueTickets: Bi,
    setQueueFilter: Vi,
    setQueueSearch: Qi,
    setQueueSelection: Mi,
    setQueueStateWithTickets: Fi,
    toggleQueueTicketSelection: Ei,
    updateQueueUi: zi,
});
function Ji(e, t) {
    const a = De(t.createdAt, t.created_at, e?.createdAt, e?.created_at),
        n = De(
            t.priorityClass,
            t.priority_class,
            e?.priorityClass,
...
function Yi(e, t = {}) {
    ...
    const i = (g().data.queueTickets || []).map((e, t) => Ue(e, t)),
        o = a.__fullTickets || [];
    if (
        !(function (e, t, a) {
            return (
                ...
                !!(function (e) {
                    return (
                        ...
                        Qe(e, 'called_count') ||
                        Qe(e, 'completedCount') ||
                        Qe(e, 'completed_count') ||
                        Qe(e, 'noShowCount') ||
                        Qe(e, 'no_show_count') ||
                        Qe(e, 'cancelledCount') ||
                        Qe(e, 'cancelled_count')
                    );
                })(e) ||
                !!(function (e) {
                    const t = Ge(e);
                ...
                !(!Qe(e, 'nextTickets') && !Qe(e, 'next_tickets')) ||
                (function (e) {
                    const t = (function (e) {
                        return e?.callingNowByConsultorio &&
                            'object' == typeof e.callingNowByConsultorio
        ...
        return;
    const s = 'fallback' === Ne(t.syncMode) ? 'fallback' : 'live',
        r = Ve(a, i),
        l = (function (e) {
            const t = Ge(e),
                a =
                    Qe(e, 'waitingCount') ||
                    Qe(e, 'waiting_count') ||
                    Boolean(t && Qe(t, 'waiting')),
                n =
                    Qe(e, 'calledCount') ||
                    Qe(e, 'called_count') ||
                    Boolean(t && Qe(t, 'called')),
                i = Qe(e, 'nextTickets') || Qe(e, 'next_tickets'),
                o =
                    Qe(e, 'callingNowByConsultorio') ||
                    Qe(e, 'calling_now_by_consultorio') ||
                    Qe(e, 'callingNow') ||
                    Qe(e, 'calling_now');
    ...
    const p = new Map(i.map((e) => [We(e), e]));
    ((function (e, t, a) {
        const n = t.callingNowByConsultorio || {},
            ...
            r = (function (e) {
                const t = new Set(),
                    a = e[1] || e[1] || null,
                    n = e[2] || e[2] || null;
                return (a && t.add(We(a)), n && t.add(We(n)), t);
            })(n),
            l = new Set(s.map((e) => We(e))),
            c = r.size > 0 || 0 === i,
            u = l.size > 0 || 0 === o,
            d = l.size > 0 && o > l.size;
        ...
        Fi(
            (function (e, t, a) {
                for (const a of t) {
                    const t = We(a),
                        n = e.get(t) || null;
                    e.set(t, Ue(Ji(n, a), e.size));
                }
                if (a && 'object' == typeof a) {
                    const t = We(Ue(a, e.size)),
                        n = e.get(t) || null;
                    e.set(
                        t,
                        Ue(
...
function Xi(e, t = '') {
    return (
        ...
        (Fi(e.queueTickets, e.queueMeta || null, {
            fallbackPartial: !0,
            syncMode: 'fallback',
        }),
        t && Ti(t),
...
async function eo() {
    try {
        (Yi(await _('queue-state'), { syncMode: 'live' }),
            Ti('Queue refresh realizado'));
    } catch (e) {
        (Ti('Queue refresh con error'), Xi(Zi()));
    }
}
async function to() {
    const e = Array.isArray(g().data.queueTickets)
            ? g().data.queueTickets.map((e, t) => Ue(e, t))
            : [],
        t = (function (e) {
            return g().data.queueMeta && 'object' == typeof g().data.queueMeta
                ? Ve(g().data.queueMeta, e)
                : null;
        })(e);
    e.length
        ? Fi(e, t || null, { fallbackPartial: !1, syncMode: 'live' })
        : (function (e) {
              const t = e ? Ye(e) : [];
              return (
                  !!t.length &&
                  (Fi(t, e, { fallbackPartial: !0, syncMode: 'fallback' }),
                  Ti('Queue fallback parcial desde metadata'),
                  !0)
              );
          })(t) ||
          (await eo(),
          (g().data.queueTickets || []).length ||
              Xi(Zi(), 'Queue fallback desde snapshot local') ||
              Fi([], null, { fallbackPartial: !1, syncMode: 'live' }));
}
const ao = 'appointments',
    no = 'callbacks',
    io = 'reviews',
    oo = 'availability',
    so = 'availability-meta',
    ro = 'queue-tickets',
    lo = 'queue-meta',
    co = 'leadops-meta',
    uo = 'queue-surface-status',
    po = 'app-downloads',
    mo = 'health-status',
    go = {
        summary: {
...
function bo() {
    return {
        ...
        reviews: L(io, []),
        availability: L(oo, {}),
        availabilityMeta: L(so, {}),
        queueTickets: L(ro, []),
        queueMeta: L(lo, null),
        leadOpsMeta: L(co, null),
        queueSurfaceStatus: L(uo, null),
        appDownloads: L(po, null),
        health: L(mo, null),
        funnelMetrics: go,
    };
}
...
async function qo() {
    ...
    try {
        const [t, a] = await Promise.all([
            ...
            })({ ...n, funnelMetrics: await ko(n) }, a, i),
            { preservedQueueData: s } = vo(o, { queueRuntimeRevision: e });
        return (
            (function (e) {
                (A(ao, e.appointments || []),
                    A(no, e.callbacks || []),
                    A(io, e.reviews || []),
                    A(oo, e.availability || {}),
                    A(so, e.availabilityMeta || {}),
                    A(ro, e.queueTickets || []),
                    A(lo, e.queueMeta || null),
                    A(co, e.leadOpsMeta || null),
                    A(uo, e.queueSurfaceStatus || null),
                    A(po, e.appDownloads || null),
                    A(mo, e.health || null));
            })(o),
            { ok: !0, preservedQueueData: s }
        );
    } catch (e) {
        return (vo(bo()), { ok: !1, preservedQueueData: !1 });
    }
}
let $o = !1,
    _o = !1;
...
function Ao(e = {}) {
    const { immediate: t = !1, reason: a = 'sync' } = e,
        ...
        i = Co();
    return (
        So({ state: n.state, reason: n.reason, intervalMs: i, inFlight: _o }),
        'queue' === g().ui?.activeSection && Ai(),
        t && n.active ? (Lo(a), !0) : n.active
    );
}
function To() {
    'visible' !== document.visibilityState ? Ao() : Lo('visibility');
}
function Mo() {
    ('undefined' != typeof document && 'hidden' === document.visibilityState) ||
        ('queue' === g().ui?.activeSection && Lo('focus'));
}
function Eo() {
    'queue' === g().ui?.activeSection && Lo('online');
}
function Bo(e, t, a = void 0) {
    Ki(e, (e) => ({
        ...e,
        status: t,
...
async function No({ ticketId: e, action: t, consultorio: a }) {
    const n = Number(e || 0),
        i = Pe(t);
    if (n && i)
            ...
            ? ((function (e, t, a) {
                  'reasignar' !== t && 're-llamar' !== t
                      ? 'liberar' !== t
                          ? 'completar' !== t
                              ? 'no_show' !== t
                                  ? 'cancelar' === t && Bo(e, 'cancelled')
                                  : Bo(e, 'no_show')
                              : Bo(e, 'completed')
                          : Bo(e, 'waiting', null)
                      : Bo(e, 'called', 2 === Number(a || 1) ? 2 : 1);
              })(n, i, a),
              void Ti(`Practica: accion ${i} en ticket ${n}`))
            : (Yi(
...
async function Io(e) {
    ...
    if (!Oi.get(t)) {
        if (
            ...
            return (
                Ti(`Llamado bloqueado para C${t} por lock de estacion`),
        ...
        if (a.queue.practiceMode) {
            ...
            return e
                ? ((function (e, t) {
                  ...
                  void Ti(`Practica: llamado ${e.ticketCode} en C${t}`))
                : void Ti('Practica: sin tickets en espera');
        }
        Oi.set(t, !0);
        try {
            (Yi(
                ...
                Ti(`Llamado C${t} ejecutado`));
        } catch (e) {
            (Ti(`Error llamando siguiente en C${t}`),
...
async function Po(e, t, a = 0) {
    ...
    if (
        ...
        return (Ae(n), void Ti(`Accion ${n.action} pendiente de confirmacion`));
    await No(n);
}
async function jo(e) {
    const t = 2 === Number(e || 0) ? 2 : 1,
        a = it(t);
    a
        ? await Po(a.id, 'liberar', t)
        : Ti(`Sin ticket activo para liberar en C${t}`);
}
async function xo() {
    const e = g().queue.pendingSensitiveAction;
    e ? (Te(), await No(e)) : Te();
...
function Ro() {
    (Te(), Ti('Accion sensible cancelada'));
}
function Do() {
    const e = document.getElementById('queueSensitiveConfirmDialog'),
...
async function Oo(e) {
    ...
    if (t.length) {
        ...
        (Ni(), Ti(`Bulk ${a} sobre ${t.length} tickets`));
    }
}
async function Ho(e) {
    const t = Number(e || 0);
    t &&
        (g().queue.practiceMode
            ? Ti(`Practica: reprint ticket ${t}`)
            : (await _('queue-reprint', { method: 'POST', body: { id: t } }),
              Ti(`Reimpresion ticket ${t}`)));
}
async function Uo() {
    const e = at();
    for (const t of e)
    ...
    (Ni(), Ti(`Bulk reimpresion ${e.length}`));
}
var Fo = Object.freeze({
    __proto__: null,
    callNextForConsultorio: Io,
    cancelQueueSensitiveAction: Ro,
    confirmQueueSensitiveAction: xo,
    dismissQueueSensitiveDialog: Do,
    reprintQueueTicket: Ho,
    runQueueBulkAction: Oo,
    runQueueBulkReprint: Uo,
    runQueueReleaseStation: jo,
    runQueueTicketAction: Po,
});
function Ko() {
    zi({ helpOpen: !g().queue.helpOpen });
}
function zo(e) {
    const t = Boolean(e);
    (zi({ practiceMode: t, pendingSensitiveAction: null }),
        Ti(t ? 'Modo practica activo' : 'Modo practica desactivado'));
}
function Vo(e) {
    const t = st();
    return (
...
async function Qo(e) {
    ...
    if (t.queue.captureCallKeyMode)
        return void (function (e) {
            ...
            (zi({ customCallKey: t, captureCallKeyMode: !1 }),
                s('Tecla externa guardada', 'success'),
                Ti(`Tecla externa calibrada: ${t.code}`));
        })(e);
    if (
        (function (e, t) {
            return (
        ...
        return void (await Io(t.queue.stationConsultorio));
    const a = Ne(e.code),
        n = Ne(e.key),
        i = (function (e, t, a) {
            return (
    ...
    if (i && t.queue.pendingSensitiveAction) return void (await xo());
    const o = (function (e, t) {
    ...
    if (!o)
        return i
            ? (t.queue.oneTap && Vo(t) && (await xo()),
              void (await Io(t.queue.stationConsultorio)))
            : void ((function (e, t) {
                  return (
                      'numpaddecimal' === e ||
                      'kpdecimal' === e ||
    ...
    !(function (e, t) {
        (function (e, t) {
            ...
            ? (s('Cambio bloqueado por modo estación', 'warning'),
              Ti('Cambio de estación bloqueado por lock'))
            : (zi({ stationConsultorio: e }), Ti(`Numpad: estacion C${e}`));
    })(o, t);
}
function Go(e, t) {
...
const Yo = 'themeMode',
    Zo = new Set(['light', 'dark', 'system']);
function Xo(e, { persist: t = !1 } = {}) {
    const a = (function (e) {
        const t = (function (e) {
...
const es = 'adminLastSection',
    ts = 'adminSidebarCollapsed';
function as() {
...
function os() {
    const e = g();
    (w(es, e.ui.activeSection), w(ts, e.ui.sidebarCollapsed ? '1' : '0'));
}
...
function cs() {
    (rs((e) => ({ sidebarOpen: !e.sidebarOpen })), is());
}
function us({ restoreFocus: e = !1 } = {}) {
    if (
        (b((e) => ({
            ...e,
...
const ps = 'admin-appointments-sort',
    ms = 'admin-appointments-density',
    gs = 'datetime_desc',
    bs = 'comfortable';
function ys(e) {
    return String(e || '')
...
function fs(e) {
    return ys(e.paymentStatus || e.payment_status || '');
}
function vs(e) {
    return ys(e);
}
...
function Ls(e, t) {
    ...
    return 'pending_transfer' === a
        ...
        : 'upcoming_48h' === a
          ? e.filter(_s)
          : 'no_show' === a
            ? e.filter((e) => 'no_show' === vs(e.status))
            : 'triage_attention' === a
              ? e.filter(ws)
              : e;
}
...
function Ts(e, t) {
    const a = ys(t),
        n = [...e];
    return 'patient_az' === a
        ? (n.sort((e, t) => ys(e.name).localeCompare(ys(t.name), 'es')), n)
        : 'datetime_asc' === a
          ? (n.sort((e, t) => ks(e) - ks(t)), n)
          : (n.sort((e, t) => ks(t) - ks(e)), n);
}
function Ms(e) {
    const t = fs(e),
        a = vs(e.status),
...
function Es(e) {
    ...
    const n = t.find(({ item: e }) => 'no_show' === vs(e.status));
    if (n)
        return {
            item: n.item,
        ...
        ? t
              .map((t) => {
                  ...
                  return `\n                <tr class="appointment-row" data-appointment-id="${Number(t.id || 0)}">\n                    <td data-label="Paciente">\n                        <div class="appointment-person">\n                            <strong>${e(t.name || 'Sin nombre')}</strong>\n                            <span>${e(t.email || 'Sin email')}</span>\n                            <small>${e(t.phone || 'Sin telefono')}</small>\n                        </div>\n                    </td>\n                    <td data-label="Servicio">${(function (
                      ...
                      const a = Ms(t);
                      return `\n        <div class="appointment-service">\n            <strong>${e(hs(t.service, 'Servicio pendiente'))}</strong>\n            <span>Especialista: ${e(hs(t.doctor, 'Sin asignar'))}</span>\n            <small>${e(a.label)} | ${e(a.note)}</small>\n        </div>\n    `;
                  })(
                      t
                      ...
                      )}">${e(Cs(a))}</span>\n            <small>Metodo: ${e(((i = t.paymentMethod || t.payment_method || ''), { transfer: 'Transferencia', cash: 'Consultorio', card: 'Tarjeta', gateway: 'Pasarela' }[ys(i)] || hs(i, 'Metodo pendiente')))}</small>\n            ${n ? `<a href="${e(n)}" target="_blank" rel="noopener">Ver comprobante</a>` : '<small>Sin comprobante adjunto</small>'}\n        </div>\n    `;
                      var i;
                  })(
                      t
...
function Ns() {
    const t = g(),
        ...
        o = Ts(As(Ls(a, i.filter), i.search), i.sort);
    (l('#appointmentsTableBody', Bs(o)),
        (function (e, t, a) {
                ...
                r(
                    ...
                    (function (e, t) {
                        ...
                        if ('all' !== ys(e.filter)) {
                            ...
                            a.push(t[ys(e.filter)] || e.filter);
                        }
                        return (
                            ys(e.search) && a.push(`Busqueda: ${e.search}`),
                            'patient_az' === ys(e.sort)
                                ? a.push('Paciente (A-Z)')
                                : 'datetime_asc' === ys(e.sort)
            ...
            if (n) {
                const t = 'all' !== ys(e.filter) || '' !== ys(e.search);
            ...
            (l &&
                ...
                document
                    ...
                    .forEach((t) => {
                        const a = ys(t.dataset.density) === ys(e.density);
                        t.classList.toggle('is-active', a);
                    }),
                (function (e) {
                    const t = ys(e);
                    document
                        ...
                        .forEach((e) => {
                            const a = ys(e.dataset.filterValue) === t;
                            e.classList.toggle('is-active', a);
                        });
                })(e.filter),
                (function (e) {
                    try {
                        (localStorage.setItem(ps, JSON.stringify(e.sort)),
        ...
        (function (t, a, i) {
            ...
            (r('#appointmentsFocusPatient', c.name || 'Sin nombre'),
                r(
                    '#appointmentsFocusMeta',
                    `${hs(c.service, 'Servicio pendiente')} | ${n(c.date)} ${c.time || '--:--'}`
                ),
                r('#appointmentsFocusWindow', qs(ks(c))),
                r(
                    '#appointmentsFocusPayment',
                    Cs(c.paymentStatus || c.payment_status)
                ),
                r('#appointmentsFocusStatus', Ss(c.status)),
            ...
            (function (e) {
                const t = Ls(e, 'pending_transfer'),
                    a = Ls(e, 'upcoming_48h'),
                    n = Ls(e, 'no_show'),
                    i = Ls(e, 'triage_attention'),
                    o = e.filter($s);
                return {
...
function Is(e) {
    (b((t) => ({ ...t, appointments: { ...t.appointments, ...e } })), Ns());
}
function Ps(e) {
    Is({ filter: ys(e) || 'all' });
}
...
const Ds = 'admin-callbacks-sort',
    Os = 'admin-callbacks-filter',
    Hs = new Set(['all', 'pending', 'contacted', 'today', 'sla_urgent']),
    Us = new Set(['priority_desc', 'recent_desc', 'waiting_desc']);
function Fs(e) {
    return String(e || '')
        .toLowerCase()
        .trim();
...
function Ks(e) {
    const t = Fs(e);
    return Hs.has(t) ? t : 'all';
}
function zs(e) {
    const t = Fs(e);
    return Us.has(t) ? t : 'priority_desc';
}
function Vs(e) {
    const t = Fs(e);
...
function er(e) {
    const t = Array.isArray(Ys(e).serviceHints) ? Ys(e).serviceHints : [];
    return String(t[0] || '').trim() || 'Sin sugerencia';
}
function tr(e) {
    return (
        String(Ys(e).nextAction || '').trim() || 'Mantener visible en la cola'
    );
}
function ar(e, t = '') {
    const a = Fs(Ys(e).aiStatus);
    return 'requested' === a
        ? 'online' === t
            ? 'IA pendiente'
            : 'IA no disponible'
...
function nr(e) {
    return String(Ys(e).aiDraft || '').trim();
}
function ir(e) {
    const t = Number(Ys(e).heuristicScore || 0);
    return Number.isFinite(t) ? t : 0;
}
function or(e) {
    return (
...
function sr(e) {
    try {
        (localStorage.setItem(Os, JSON.stringify(Ks(e.filter))),
            localStorage.setItem(Ds, JSON.stringify(zs(e.sort))));
    } catch (e) {}
}
function rr(e, t) {
    const a = Ks(t);
    return 'pending' === a || 'contacted' === a
        ? e.filter((e) => Vs(e.status) === a)
        : 'today' === a
          ? e.filter((e) => Js(e.fecha || e.createdAt))
          : 'sla_urgent' === a
            ? e.filter((e) => 'pending' === Vs(e.status) && Gs(e) >= 120)
            : e;
}
function lr(e, t, a = '') {
    const n = Fs(t);
...
function cr(e, t) {
    ...
    return 'waiting_desc' === a
        ? (n.sort((e, t) => Qs(e) - Qs(t)), n)
        : 'recent_desc' === a
          ? (n.sort((e, t) => Qs(t) - Qs(e)), n)
          : (n.sort((e, t) => {
                const a = Xs(t) - Xs(e);
                if (0 !== a) return a;
                const n = ir(t) - ir(e);
                return 0 !== n ? n : Qs(e) - Qs(t);
            }),
            n);
}
function ur() {
    const t = g(),
        ...
        o = t.callbacks,
        s = cr(
            lr(rr(a, o.filter), o.search, String(n?.worker?.mode || '')),
            o.sort
        ),
        c = new Set((o.selected || []).map((e) => Number(e || 0))),
        u = (function (e, t = null) {
            const a = e.filter((e) => 'pending' === Vs(e.status)),
                n = a.filter((e) => Gs(e) >= 120),
                i = a.filter((e) => 3 === Xs(e)),
                o = a.slice().sort((e, t) => {
                    const a = Xs(t) - Xs(e);
                    return 0 !== a ? a : Qs(e) - Qs(t);
                })[0],
                s = Fs(t?.worker?.mode || '');
            return {
                ...
                hotCount: i.length,
                todayCount: e.filter((e) => Js(e.fecha || e.createdAt)).length,
                next: o,
                workerMode: s,
                queueHealth:
    ...
    (l(
            ...
            ? s
                  .map((t, a) =>
                      (function (
                          ...
                          )}</span>\n                        <span class="callback-status-pill subtle">${e(ar(t, o))}</span>\n                    </div>\n                    <h4>${e(l)}</h4>\n                    <p class="callback-card-subtitle">${e(1 === n ? 'Siguiente lead sugerido' : 'Lead interno')}${ir(t) ? ` · Score ${e(String(ir(t)))}` : ''}</p>\n                </div>\n                <span class="callback-card-wait" data-tone="${e('pending' === s ? u : 'success')}">${e(Ws(c))}</span>\n            </header>\n            <div class="callback-card-grid">\n                <p><span>Servicio</span><strong>${e(er(t))}</strong></p>\n                <p><span>Fecha</span><strong>${e(i(t.fecha || t.createdAt || ''))}</strong></p>\n                <p><span>Siguiente accion</span><strong>${e(tr(t))}</strong></p>\n                <p><span>Outcome</span><strong>${e(
                              (function (e) {
                                  const t = Fs(Ys(e).outcome);
        ...
        (function (e, t, a) {
                        ...
                        return (
                            'all' !== Ks(e.filter) &&
                                t.push(
                                    'pending' === Ks(e.filter)
                                        ? 'Pendientes'
                                        : 'contacted' === Ks(e.filter)
                                          ? 'Contactados'
                                          : 'today' === Ks(e.filter)
                                            ? 'Hoy'
                                            : 'Urgentes SLA'
                                ),
                            Fs(e.search) && t.push(`Busqueda: ${e.search}`),
                            'priority_desc' === zs(e.sort)
                                ? t.push('Orden: Prioridad comercial')
                                : 'waiting_desc' === zs(e.sort)
            ...
            n instanceof HTMLSelectElement && (n.value = Ks(e.filter));
            const i = document.getElementById('callbackSort');
            i instanceof HTMLSelectElement && (i.value = zs(e.sort));
            ...
            (o instanceof HTMLInputElement &&
                ...
                (function (e) {
                    ...
                    document
                        ...
                        .forEach((e) => {
                            const a = Fs(e.dataset.filterValue) === t;
                            e.classList.toggle('is-active', a);
                        });
                })(e.filter),
                sr(e));
        ...
        (function (e, t, a, n) {
            ...
            const s = e.next;
            (r('#callbacksOpsNext', s ? or(s) : 'Sin telefono'),
                r(
                    '#callbacksNextSummary',
                    s
                        ? `Prioriza ${or(s)} antes de seguir con la cola.`
                        : 'La siguiente llamada prioritaria aparecera aqui.'
                ),
                r('#callbacksNextWait', s ? Ws(Gs(s)) : '0 min'),
                r('#callbacksNextPreference', s ? er(s) : '-'),
                r('#callbacksNextState', s ? tr(s) : 'Pendiente'),
                r(
                    '#callbacksDeckHint',
                    s ? ar(s, e.workerMode) : 'Sin bloqueos'
                ));
...
function dr(e, { persist: t = !0 } = {}) {
    (b((t) => ({ ...t, callbacks: { ...t.callbacks, ...e } })),
        t && sr(g().callbacks),
        ur());
}
function pr(e) {
    dr({ filter: Ks(e), selected: [] });
}
function mr(e) {
    const t = Number(e?.id || 0);
    (b((a) => ({
...
const fr = {
    appointments_overview: async () => {
        (await ss('appointments'), Ps('all'), js(''));
    },
    appointments_pending_transfer: async () => {
        (await ss('appointments'), Ps('pending_transfer'), js(''));
    },
    appointments_all: async () => {
        (await ss('appointments'), Ps('all'), js(''));
    },
    appointments_no_show: async () => {
        (await ss('appointments'), Ps('no_show'), js(''));
    },
    callbacks_pending: async () => {
        (await ss('callbacks'), pr('pending'));
    },
    callbacks_contacted: async () => {
        (await ss('callbacks'), pr('contacted'));
    },
    callbacks_sla_urgent: async () => {
        (await ss('callbacks'), pr('sla_urgent'));
    },
    availability_section: async () => {
        await ss('availability');
    },
    queue_sla_risk: async () => {
        (await ss('queue'), Vi('sla_risk'));
    },
    queue_waiting: async () => {
        (await ss('queue'), Vi('waiting'));
    },
    queue_called: async () => {
        (await ss('queue'), Vi('called'));
    },
    queue_no_show: async () => {
        (await ss('queue'), Vi('no_show'));
    },
    queue_all: async () => {
        (await ss('queue'), Vi('all'));
    },
    queue_call_next: async () => {
        (await ss('queue'), await Io(g().queue.stationConsultorio));
    },
};
async function vr(e) {
    const t = fr[e];
...
function Cr(e = g()) {
    ...
    if ('callbacks' === t) {
        const t = (function (e) {
                ...
                return cr(
                    lr(
                        rr(e.data.callbacks || [], e.callbacks.filter),
                        e.callbacks.search,
                        t
                    ),
                    e.callbacks.sort
        ...
        const t = (function (e) {
                return Ts(
                    As(
                        Ls(e.data.appointments || [], e.appointments.filter),
        ...
        'queue' === t &&
            ...
            (a.visibleIds = (e.data.queueTickets || []).map((e) =>
                Number(e.id || e.ticketId || 0)
            )));
    return a;
}
function Sr() {
...
async function wr() {
    ...
    if (!0 !== e.auth?.authenticated)
        return (qr({ keepOpen: !0 === e.agent?.open }), Sr(), null);
    try {
        const t = await _('admin-agent-status'),
            a = $r(t?.data) || t?.data || null;
        return (
            a?.session || a?.health
                ? _r(a)
                : qr({ keepOpen: !0 === e.agent?.open }),
            Sr(),
            a
        );
    } catch (e) {
...
function Pr(e) {
    return Ir(`${e?.date || ''}T${e?.time || '00:00'}:00`);
}
function jr(e) {
    if (!e) return 'Sin fecha';
    const t = Math.round((e - Date.now()) / 6e4),
...
function Rr(e) {
    const {
        ...
        c = (function (e) {
            return e.filter((e) => {
                const t = Nr(e.paymentStatus || e.payment_status);
                return (
                    'pending_transfer_review' === t || 'pending_transfer' === t
                );
            }).length;
        ...
        u = (function (e) {
            return e.filter((e) => 'pending' === Nr(e.status)).length;
        })(n),
        d = (function (e) {
            return e.filter((e) => {
                if ('pending' !== Nr(e.status)) return !1;
                const t = (function (e) {
                    return Ir(e?.fecha || e?.createdAt || '');
                })(e);
                return !!t && Math.round((Date.now() - t) / 6e4) >= 120;
            }).length;
        })(n),
        p = (function (e) {
            return e.filter((e) => 'no_show' === Nr(e.status)).length;
        })(t),
        m = (function (e) {
            return e.length
                ? (
    ...
    ((function (e) {
                    ...
                    : a > 0
                      ...
                      : e > 0
                        ...
                        : n > 0
                          ...
                          : i?.item
                            ? `La siguiente atencion es ${i.item.name || 'sin nombre'} ${jr(i.stamp).toLowerCase()}.`
        ...
        (function (e) {
            ...
            (r(
                ...
                r(
                    '#dashboardFlowStatus',
                    n?.item
                        ? `${jr(n.stamp)} | ${n.item.name || 'Paciente'}`
                        : t > 0
                ...
                r(
                    ...
                    o > 0
                        ...
                        : n?.item
                          ? `Siguiente paciente: ${n.item.name || 'Paciente'} ${jr(n.stamp).toLowerCase()}`
            ...
            (function (e) {
                ...
                return [
                    xr(
                        ...
                        'Abrir agenda',
                        n?.item
                            ? `Siguiente cita ${jr(n.stamp).toLowerCase()}`
        ...
        (function (e) {
            ...
            (r('#funnelViewBooking', o(t.viewBooking || 0)),
                ...
                l(
                    '#funnelEntryList',
                    Er(e.checkoutEntryBreakdown, 'entry', 'count')
                ),
                l(
                    '#funnelSourceList',
                    Er(e.sourceBreakdown, 'source', 'count')
                ),
                l(
                    '#funnelPaymentMethodList',
                    Er(e.paymentMethodBreakdown, 'method', 'count')
                ),
                l(
                    '#funnelAbandonList',
                    Er(e.checkoutAbandonByStep, 'step', 'count')
                ),
                l(
                    '#funnelAbandonReasonList',
                    Er(e.abandonReasonBreakdown, 'reason', 'count')
                ),
                l(
                    '#funnelStepList',
                    Er(e.bookingStepBreakdown, 'step', 'count')
                ),
                l(
                    '#funnelErrorCodeList',
                    Er(e.errorCodeBreakdown, 'code', 'count')
                ));
        })(t.funnel));
}
function Or(e) {
...
function zr() {
    const t = g(),
        ...
        n = (function (e) {
            return e.slice().sort((e, t) => Hr(t) - Hr(e));
        })(a),
        o = (function (e) {
            return e.length
                ...
                return t
                    .map((t) =>
                        (function (t, { featured: a = !1 } = {}) {
                            ...
                            return `\n        <article class="review-card${a ? ' is-featured' : ''}" data-rating="${e(String(n))}">\n            <header>\n                <div class="review-card-heading">\n                    <span class="review-avatar">${e(Fr(t.name || 'Anonimo'))}</span>\n                    <div>\n                        <strong>${e(t.name || 'Anonimo')}</strong>\n                        <small>${e(i(t.date || t.createdAt || ''))}</small>\n                    </div>\n                </div>\n                <span class="review-rating-badge" data-tone="${e(o)}">${e(Ur(n))}</span>\n            </header>\n            <p>${e(Kr(t.comment || t.review || ''))}</p>\n            <small>${e(s)}</small>\n        </article>\n    `;
                        })(t, {
                            featured:
                                a.item &&
                                Or(t.name) === Or(a.item.name) &&
                                Hr(t) === Hr(a.item),
                        })
                    )
                    .join('');
...
async function Jr(e, t) {
    switch (e) {
        case 'appointment-quick-filter':
            return (Ps(String(t.dataset.filterValue || 'all')), !0);
        case 'clear-appointment-filters':
            return (Is({ filter: 'all', search: '' }), !0);
        case 'appointment-density':
            return (
                Is({
                    density:
                        'compact' ===
                        ys(String(t.dataset.density || 'comfortable'))
                            ? 'compact'
                            : bs,
                }),
                !0
        ...
        case 'approve-transfer':
            return (
                await (async function (e) {
                    (await Rs(e, { paymentStatus: 'paid' }),
                        xs(e, { paymentStatus: 'paid' }));
        ...
        case 'reject-transfer':
            return (
                await (async function (e) {
                    (await Rs(e, { paymentStatus: 'failed' }),
                        xs(e, { paymentStatus: 'failed' }));
                })(Number(t.dataset.id || 0)),
        ...
        case 'cancel-appointment':
            return (
                await (async function (e) {
                    (await Rs(e, { status: 'cancelled' }),
                        xs(e, { status: 'cancelled' }));
                })(Number(t.dataset.id || 0)),
...
async function Zr(e, t) {
    switch (e) {
        case 'callback-quick-filter':
            return (pr(String(t.dataset.filterValue || 'all')), !0);
        ...
        case 'context-open-callbacks-next':
            return (await ss('callbacks'), pr('pending'), yr(), !0);
        case 'mark-contacted':
            return (
                await br(
        ...
        case 'lead-ai-request':
            return (
                await (async function (e, t = 'whatsapp_draft') {
                    ...
                    return n?.data ? (mr(n.data), n.data) : null;
                })(
                    Number(t.dataset.callbackId || 0),
        ...
        case 'callbacks-bulk-clear':
            return (dr({ selected: [] }, { persist: !1 }), !0);
        ...
        case 'context-open-callbacks-pending':
            return (await ss('callbacks'), pr('pending'), !0);
        default:
            return !1;
    }
}
async function Xr(e) {
    switch (e) {
        case 'context-open-appointments-overview':
            return (await ss('appointments'), Ps('all'), js(''), !0);
        case 'context-open-appointments-transfer':
            return (await ss('appointments'), Ps('pending_transfer'), !0);
        case 'context-open-availability':
            return (await ss('availability'), !0);
        case 'context-open-dashboard':
            return (await ss('dashboard'), !0);
        default:
            return !1;
    }
}
async function el(e, t) {
    switch (e) {
        case 'queue-bulk-action':
            return (await Oo(String(t.dataset.queueAction || 'no_show')), !0);
    ...
    switch (e) {
        ...
        case 'queue-lock-station':
            return (
                (function (e) {
                    const t = 2 === Number(e || 0) ? 2 : 1;
                    (zi({ stationMode: 'locked', stationConsultorio: t }),
                        Ti(`Estacion bloqueada en C${t}`));
                })(nl(t, 1)),
                !0
            );
            ...
            return (
                (function (e) {
                    if ('free' === Ne(e))
                        return (
                            zi({ stationMode: 'free' }),
                            void Ti('Estacion en modo libre')
                        );
                    zi({ stationMode: 'locked' });
                })(String(t.dataset.queueMode || 'free')),
                !0
            );
        case 'queue-capture-call-key':
            return (
                zi({ captureCallKeyMode: !0 }),
        ...
        case 'queue-clear-call-key':
            return (
                window.confirm('¿Quitar tecla externa calibrada?') &&
                    (zi({ customCallKey: null, captureCallKeyMode: !1 }),
...
async function sl(e, t) {
    switch (e) {
        ...
        case 'queue-reprint-ticket':
            return (await Ho(il(t)), !0);
        case 'queue-clear-search':
            return (Gi(), !0);
        case 'queue-open-quick-tray':
            return (
                Gi(),
                Vi(String(t?.dataset?.queueFilterValue || 'all')),
                !0
            );
...
async function ll(e, t) {
    switch (e) {
        ...
        case 'set-admin-theme':
            return (
                Xo(String(t.dataset.themeMode || 'system'), { persist: !0 }),
                !0
            );
        ...
        case 'open-agent-panel':
            return (await Lr({ focus: !0 }), !0);
        case 'close-agent-panel':
            return (kr({ open: !1 }), z(), Sr(), !0);
        case 'admin-agent-submit': {
                    ...
                    const a = await (async function () {
                        ...
                        try {
                            const e = await _('admin-agent-session-start', {
                                ...
                                t = $r(e?.data) || e?.data || null;
                            return (_r(t), Sr(), t?.session?.sessionId || '');
                        } catch (e) {
                            throw (
                                kr({
                                    starting: !1,
            ...
            return (
                ...
                a?.refreshRecommended && (await Qr(!1)),
        ...
        case 'admin-agent-cancel':
            return (
                await (async function () {
                    ...
                    if (!t) return (qr({ keepOpen: !0 }), Sr(), null);
                    (kr({ submitting: !0, lastError: '' }), Sr());
                    try {
...
async function cl() {
    (!(function () {
        ...
        (function () {
            ...
            (e instanceof HTMLElement &&
                ...
                Object.entries(Tr).forEach(([e, t]) => {
                    (Mr(e, t.hero, 'data-admin-section-hero'),
                        Mr(e, t.priority, 'data-admin-priority-rail'),
                        Mr(e, t.workbench, 'data-admin-workbench'),
                        Mr(e, t.detail, 'data-admin-detail-rail'));
                }));
        })(),
        ...
        document.addEventListener('click', (e) => {
            ...
            t &&
                (e.preventDefault(),
                Vi(String(t.getAttribute('data-queue-filter') || 'all')));
        }),
        (function () {
        ...
        (function () {
            let e = gs,
                t = bs;
            try {
                ((e = JSON.parse(localStorage.getItem(ps) || `"${gs}"`)),
                    (t = JSON.parse(localStorage.getItem(ms) || `"${bs}"`)));
            } catch (e) {}
            b((a) => ({
                ...a,
                appointments: {
                    ...a.appointments,
                    sort: 'string' == typeof e ? e : gs,
                    density: 'string' == typeof t ? t : bs,
                },
            }));
        })(),
        (function () {
            let e = 'all',
                t = 'priority_desc';
            try {
                ((e = JSON.parse(localStorage.getItem(Os) || '"all"')),
                    (t = JSON.parse(
                        localStorage.getItem(Ds) || '"priority_desc"'
                    )));
            } catch (e) {}
            b((a) => ({
                ...a,
                callbacks: { ...a.callbacks, filter: Ks(e), sort: zs(t) },
            }));
        })(),
        (function () {
            let e = '',
        ...
        (function () {
            const e = {
                    stationMode:
                        'locked' === Ne(S(Ii, 'free')) ? 'locked' : 'free',
                    stationConsultorio: 2 === Number(S(Pi, '1')) ? 2 : 1,
                    oneTap: '1' === S(ji, '0'),
                    helpOpen: '1' === S(Ri, '0'),
                    customCallKey: L(xi, null),
                },
                t = Ne(T('station')),
                a = Ne(T('lock')),
                n = Ne(T('one_tap'));
            (b((i) => ({
                ...
                queue: {
                    ...i.queue,
                    stationMode: Wo(a, e.stationMode),
                    stationConsultorio: Go(t, e.stationConsultorio),
                    oneTap: Jo(n, e.oneTap),
                    helpOpen: e.helpOpen,
                    customCallKey:
        ...
        Xo(
            (function () {
                const e = String(S(Yo, 'system') || 'system')
                    .trim()
                    .toLowerCase();
                return Zo.has(e) ? e : 'system';
            })()
        ),
        Gr(),
        (function () {
        ...
        (function () {
            ...
            (e?.addEventListener('click', () => {
                ...
                a?.addEventListener('click', () => us({ restoreFocus: !0 })),
                n?.addEventListener('click', () => us({ restoreFocus: !0 })),
                window.addEventListener('resize', () => {
                    as() ? is() : us();
                }),
                document.addEventListener('keydown', (e) => {
                    if (!as() || !g().ui.sidebarOpen) return;
                    if ('Escape' === e.key)
                        return (
                            e.preventDefault(),
                            void us({ restoreFocus: !0 })
                        );
                    if ('Tab' !== e.key) return;
                    const a = (function () {
                        const e = t('#adminSidebar');
                ...
                window.addEventListener('storage', (e) => {
                    'themeMode' === e.key && Xo(String(e.newValue || 'system'));
                }));
        })(),
        window.addEventListener('beforeunload', (e) => {
            we() && (e.preventDefault(), (e.returnValue = ''));
        }));
    const e = document.getElementById('loginForm');
    var a;
    (e instanceof HTMLFormElement && e.addEventListener('submit', Wr),
        (a = {
            navigateToSection: ss,
            focusAgentPrompt: Ar,
            focusCurrentSearch: ds,
            runQuickAction: vr,
            closeSidebar: () => us({ restoreFocus: !0 }),
            toggleMenu: () => {
                as() ? cs() : ls();
            },
            dismissQueueSensitiveDialog: Do,
            toggleQueueHelp: () => Ko(),
            queueNumpadAction: Qo,
        }),
    ...
    (n
        ...
        $o ||
            ...
            window.addEventListener('focus', Mo),
