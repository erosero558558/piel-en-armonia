...
function Vt(t) {
    const e = Ht(b().data.availability || {});
    return Rt(t) !== Rt(e);
}
function Ut() {
    return Ht(b().availability.draft || {});
}
function Kt() {
...
function Qt() {
    const t = b(),
        e = Pt(t.availability.selectedDate);
    if (e) return e;
    const n = Ht(t.availability.draft || {});
    ...
    ((function () {
        ...
        (function () {
            const { selectedDate: e, slots: n } = (function () {
                    ...
                    return {
                        selectedDate: e,
                        slots: xt(Ht(t.availability.draft)[e] || []),
                    };
                })(),
                a = Kt();
            (r('#selectedDate', e || '-'),
...
function ge(t, e = 0, n = {}) {
    const a = t && 'object' == typeof t ? t : {},
        i = be({ ...a, ...n }, e);
    return (
        me(a.createdAt, a.created_at) || (i.createdAt = ''),
        me(a.priorityClass, a.priority_class) || (i.priorityClass = ''),
        me(a.queueType, a.queue_type) || (i.queueType = ''),
        me(a.patientInitials, a.patient_initials) || (i.patientInitials = ''),
        i
    );
}
function fe(t, e, n) {
...
function he(t, e, n) {
    return t ? ge(t, e, { status: 'called', assignedConsultorio: n }) : null;
}
function ye(t, e = []) {
    const n = t && 'object' == typeof t ? t : {},
        ...
        o = (function (t) {
            return ue(t.callingNow).concat(ue(t.calling_now));
        })(n),
        s = (function (t) {
            const e = ue(t).map((t, e) => be(t, e));
            return {
                normalizedTickets: e,
        ...
        c = he(fe(i, o, 2), 1, 2),
        l = (function (t) {
            return ue(t.nextTickets)
                .concat(ue(t.next_tickets))
                .map((t, e) =>
                    ge(
                        {
                            ...t,
        ...
        u = Math.max(
            Number(Boolean(r)) + Number(Boolean(c)),
            s.calledFromTickets
        ),
        d = de(
            n.waitingCount ??
                ...
                a.waiting ??
                l.length ??
                s.waitingFromTickets,
            0
        ),
        p = de(n.calledCount ?? n.called_count ?? a.called ?? u, 0),
        m = de(
            a.completed ??
                n.completedCount ??
                n.completed_count ??
                s.completedFromTickets,
            0
        ),
        b = de(
            a.no_show ??
...
function we(t) {
    const e = be(t, 0);
    return e.id > 0 ? `id:${e.id}` : `code:${re(e.ticketCode || '')}`;
}
function Se(t) {
    const e = ye(t),
        n = new Map(),
    ...
    for (const t of ue(e.nextTickets))
...
const $e = 'queueStationMode',
    _e = 'queueStationConsultorio',
    Le = 'queueOneTapAdvance',
    Ee = 'queueCallKeyBindingV1',
    Ne = 'queueNumpadHelpOpen',
    De = 'queueAdminLastSnapshot',
    Be = new Map([
        [1, !1],
        [2, !1],
    ]),
    xe = new Set(['no_show', 'cancelar']);
function Pe(t) {
    (qe($e, t.queue.stationMode || 'free'),
        qe(_e, t.queue.stationConsultorio || 1),
        qe(Le, t.queue.oneTap ? '1' : '0'),
        qe(Ne, t.queue.helpOpen ? '1' : '0'),
        t.queue.customCallKey
            ? Me(Ee, t.queue.customCallKey)
            : (function (t) {
                  try {
...
function Ie() {
    const t = b(),
        e = Array.isArray(t.data.queueTickets)
            ? t.data.queueTickets.map((t, e) => be(t, e))
            : [];
    return {
        queueTickets: e,
        queueMeta:
            t.data.queueMeta && 'object' == typeof t.data.queueMeta
                ? ye(t.data.queueMeta, e)
                : se(e),
    };
}
function Fe() {
                      ...
                      ? t.filter(
                            (t) =>
                                ...
                                (Math.max(
                                    0,
                                    Math.round(
                                        (Date.now() - pe(t.createdAt)) / 6e4
                                    )
                                ) >= 20 ||
                                    'appt_overdue' === re(t.priorityClass))
                        )
                      : t;
        })(e, t.queue.filter),
        t.queue.search
...
function He(t, e = null) {
    const n = Array.isArray(e) ? e : Ie().queueTickets,
        a = new Set(n.map((t) => Number(t.id || 0)).filter((t) => t > 0));
    return [...new Set(ue(t).map((t) => Number(t || 0)))]
        .filter((t) => t > 0 && a.has(t))
        .sort((t, e) => t - e);
}
function Re() {
    return He(b().queue.selected || []);
}
function Oe() {
    const t = (function () {
        const t = new Set(Re());
        return t.size
            ? Ie().queueTickets.filter((e) => t.has(Number(e.id || 0)))
            : [];
    })();
    return t.length ? t : Fe();
}
function je(t) {
    const e = 2 === Number(t || 0) ? 2 : 1;
    return (
        Ie().queueTickets.find(
            (t) =>
                'called' === t.status &&
...
function Ge(e) {
    const n = e.assignedConsultorio ? `C${e.assignedConsultorio}` : '-',
        a = Math.max(0, Math.round((Date.now() - pe(e.createdAt)) / 6e4)),
        i = Number(e.id || 0),
        o = new Set(Re()).has(i),
        s = 'called' === e.status,
...
function We(e = () => {}) {
    const n = b(),
        ...
        o = Re(),
        s = Oe(),
        l = je(n.queue.stationConsultorio);
    (!(function (t, e) {
        const n = b(),
            a =
        ...
        if ('fallback' === re(n.queue.syncMode))
            return (
        ...
        if (!d) return;
        const p = Math.max(0, Math.round((Date.now() - pe(d)) / 1e3)),
            m = p >= 60;
        if (
            ...
            return void (
                t !== Qe &&
                ((Qe = t), e('Watchdog de cola: realtime en reconnecting'))
            );
        }
        Qe = 'live';
    })(a, e),
            ...
            const i = (function (t) {
                    return t.filter(
                        (t) =>
                            ...
                            (Math.max(
                                0,
                                Math.round((Date.now() - pe(t.createdAt)) / 6e4)
                            ) >= 20 ||
                                'appt_overdue' === re(t.priorityClass))
                    ).length;
                })(e),
...
function Ye(t, { render: e = !0 } = {}) {
    (g((e) => ({
        ...e,
        queue: { ...e.queue, selected: He(t, e.data.queueTickets || []) },
    })),
        e && We(Je));
}
function Ze() {
...
function Xe(t, e = null, n = {}) {
    const a = (Array.isArray(t) ? t : []).map((t, e) => be(t, e)),
        i = ye(e && 'object' == typeof e ? e : se(a), a),
    ...
    (g((t) => ({
        ...
        queue: {
            ...t.queue,
            selected: He(t.queue.selected || [], a),
            fallbackPartial: s,
            syncMode: r,
        },
    })),
...
function tn(t, e) {
    const n = Number(t || 0),
        a = (b().data.queueTickets || []).map((t, a) => {
            ...
            return i.id !== n
                ? i
                : be('function' == typeof e ? e(i) : { ...i }, a);
        });
    Xe(a, se(a), { fallbackPartial: !1, syncMode: 'live' });
}
function en(t) {
    (g((e) => ({ ...e, queue: { ...e.queue, ...t } })), Pe(b()), We(Je));
}
function nn(t) {
    en({ filter: re(t) || 'all', selected: [] });
}
function an(t, e = {}) {
    const n =
        t?.data?.queueState ||
    ...
    if (
        !(function (t, e, n) {
            return (
                ...
                !(!ve(t, 'nextTickets') && !ve(t, 'next_tickets')) ||
                (function (t) {
                    const e = (function (t) {
                        return t?.callingNowByConsultorio &&
                            'object' == typeof t.callingNowByConsultorio
        ...
        return;
    const o = 'fallback' === re(e.syncMode) ? 'fallback' : 'live',
        s = (b().data.queueTickets || []).map((t, e) => be(t, e)),
        r = ye(n, s),
        c = (function (t) {
            const e = ke(t),
                n =
    ...
    if (a.length) return void Xe(a, r, { fallbackPartial: !1, syncMode: o });
    const p = new Map(s.map((t) => [we(t), t]));
    ((function (t, e, n) {
        const a = e.callingNowByConsultorio || {},
            ...
            r = (function (t) {
                const e = new Set(),
                    n = t[1] || t[1] || null,
                    a = t[2] || t[2] || null;
                return (n && e.add(we(n)), a && e.add(we(a)), e);
            })(a),
            c = new Set(s.map((t) => we(t))),
            l = r.size > 0 || 0 === i,
            u = c.size > 0 || 0 === o,
            d = c.size > 0 && o > c.size;
...
function sn(t, e = '') {
    return (
        ...
        (Xe(t.queueTickets, t.queueMeta || null, {
            fallbackPartial: !0,
            syncMode: 'fallback',
        }),
        e && Je(e),
...
async function rn() {
    try {
        (an(await k('queue-state'), { syncMode: 'live' }),
            Je('Queue refresh realizado'));
    } catch (t) {
        (Je('Queue refresh con error'), sn(on()));
    }
}
...
async function ln({ ticketId: t, action: e, consultorio: n }) {
    const a = Number(t || 0),
        i = le(e);
    if (a && i)
            ...
            ? ((function (t, e, n) {
                  'reasignar' !== e && 're-llamar' !== e
                      ? 'liberar' !== e
                          ? 'completar' !== e
                              ? 'no_show' !== e
                                  ? 'cancelar' === e && cn(t, 'cancelled')
                                  : cn(t, 'no_show')
                              : cn(t, 'completed')
                          : cn(t, 'waiting', null)
                      : cn(t, 'called', 2 === Number(n || 1) ? 2 : 1);
              })(a, i, n),
              void Je(`Practica: accion ${i} en ticket ${a}`))
            : (an(
...
async function un(t) {
    ...
    if (!Be.get(e)) {
        if (
            ...
            return (
                Je(`Llamado bloqueado para C${e} por lock de estacion`),
                void s('Modo bloqueado: consultorio no permitido', 'warning')
            );
        if (n.queue.practiceMode) {
            const t = (function (t) {
                return Ie().queueTickets.find(
                    (e) =>
                        'waiting' === e.status &&
            ...
            return t
                ? ((function (t, e) {
                  ...
                  void Je(`Practica: llamado ${t.ticketCode} en C${e}`))
                : void Je('Practica: sin tickets en espera');
        }
        Be.set(e, !0);
        try {
            (an(
                ...
                Je(`Llamado C${e} ejecutado`));
        } catch (t) {
            (Je(`Error llamando siguiente en C${e}`),
...
async function dn(t, e, n = 0) {
    const a = {
        ...
        o = (function (t) {
            const e = Number(t || 0);
            return (
                (e && Ie().queueTickets.find((t) => Number(t.id || 0) === e)) ||
                null
            );
        })(a.ticketId);
    if (
        ...
        return (Ue(a), void Je(`Accion ${a.action} pendiente de confirmacion`));
    await ln(a);
}
async function pn() {
...
function mn() {
    (Ke(), Je('Accion sensible cancelada'));
}
function bn() {
    const t = document.getElementById('queueSensitiveConfirmDialog'),
...
async function gn(t) {
    ...
    e &&
        (b().queue.practiceMode
            ? Je(`Practica: reprint ticket ${e}`)
            : (await k('queue-reprint', { method: 'POST', body: { id: e } }),
              Je(`Reimpresion ticket ${e}`)));
}
function fn() {
    en({ helpOpen: !b().queue.helpOpen });
}
function hn(t) {
    const e = Boolean(t);
    (en({ practiceMode: e, pendingSensitiveAction: null }),
        Je(e ? 'Modo practica activo' : 'Modo practica desactivado'));
}
function yn(t) {
    const e = ze();
    return (
...
async function vn(t) {
    ...
    if (e.queue.captureCallKeyMode)
        return void (function (t) {
            ...
            (en({ customCallKey: e, captureCallKeyMode: !1 }),
                s('Tecla externa guardada', 'success'),
                Je(`Tecla externa calibrada: ${e.code}`));
        })(t);
    if (
        (function (t, e) {
            return (
        ...
        return void (await un(e.queue.stationConsultorio));
    const n = re(t.code),
        a = re(t.key),
        i =
            'numpadenter' === n ||
    ...
    if (i && e.queue.pendingSensitiveAction) return void (await pn());
    ...
    if (!o)
        return i
            ? (e.queue.oneTap && yn(e) && (await pn()),
              void (await un(e.queue.stationConsultorio)))
    ...
    !(function (t, e) {
        (function (t, e) {
            ...
            ? (s('Cambio bloqueado por modo estación', 'warning'),
              Je('Cambio de estación bloqueado por lock'))
            : (en({ stationConsultorio: t }), Je(`Numpad: estacion C${t}`));
    })(o, e);
}
function kn(t, e) {
...
const Cn = 'appointments',
    qn = 'callbacks',
    An = 'reviews',
    Mn = 'availability',
    Tn = 'availability-meta',
    $n = 'queue-tickets',
    _n = 'queue-meta',
    Ln = 'health-status',
    En = {
...
function Nn() {
    return {
        ...
        reviews: Ae(An, []),
        availability: Ae(Mn, {}),
        availabilityMeta: Ae(Tn, {}),
        queueTickets: Ae($n, []),
        queueMeta: Ae(_n, null),
        health: Ae(Ln, null),
        funnelMetrics: En,
    };
}
...
function Fn(t) {
    return In(`${t?.date || ''}T${t?.time || '00:00'}:00`);
}
function Hn(t) {
    if (!t) return 'Sin fecha';
    const e = Math.round((t - Date.now()) / 6e4),
...
function zn(t) {
    const {
        ...
        r = (function (t) {
            return t.filter((t) => {
                const e = Pn(t.paymentStatus || t.payment_status);
                return (
                    'pending_transfer_review' === e || 'pending_transfer' === e
                );
            }).length;
        ...
        c = (function (t) {
            return t.filter((t) => 'pending' === Pn(t.status)).length;
        })(a),
        l = (function (t) {
            return t.filter((t) => {
                if ('pending' !== Pn(t.status)) return !1;
                const e = (function (t) {
                    return In(t?.fecha || t?.createdAt || '');
                })(t);
                return !!e && Math.round((Date.now() - e) / 6e4) >= 120;
            }).length;
        })(a),
        u = (function (t) {
            return t.filter((t) => 'no_show' === Pn(t.status)).length;
        })(e),
        d = (function (t) {
            return t.length
                ? (
    ...
    ((function (t) {
                    ...
                    return t > 0
                        ...
                        : e > 0
                          ...
                          : n > 0
                            ...
                            : a?.item
                              ? `La siguiente cita es ${a.item.name || 'sin nombre'} ${Hn(a.stamp).toLowerCase()}.`
        ...
        (function (t) {
            ...
            (r(
                ...
                r(
                    '#dashboardFlowStatus',
                    n?.item
                        ? `${Hn(n.stamp)} | ${n.item.name || 'Paciente'}`
                        : e > 0
                ...
                r(
                    ...
                    n?.item
                        ? `Siguiente hito: ${n.item.name || 'Paciente'} ${Hn(n.stamp).toLowerCase()}`
            ...
            (function (t) {
                ...
                return [
                    ...
                    jn(
                        ...
                        'Actualizar tablero',
                        o?.item
                            ? `Proxima cita ${Hn(o.stamp).toLowerCase()}`
        ...
        (function (t) {
            ...
            (r('#funnelViewBooking', o(e.viewBooking || 0)),
                ...
                c(
                    '#funnelEntryList',
                    Rn(t.checkoutEntryBreakdown, 'entry', 'count')
                ),
                c(
                    '#funnelSourceList',
                    Rn(t.sourceBreakdown, 'source', 'count')
                ),
                c(
                    '#funnelPaymentMethodList',
                    Rn(t.paymentMethodBreakdown, 'method', 'count')
                ),
                c(
                    '#funnelAbandonList',
                    Rn(t.checkoutAbandonByStep, 'step', 'count')
                ),
                c(
                    '#funnelAbandonReasonList',
                    Rn(t.abandonReasonBreakdown, 'reason', 'count')
                ),
                c(
                    '#funnelStepList',
                    Rn(t.bookingStepBreakdown, 'step', 'count')
                ),
                c(
                    '#funnelErrorCodeList',
                    Rn(t.errorCodeBreakdown, 'code', 'count')
                ));
        })(e.funnel));
}
function Un(t) {
...
function Jn() {
    const e = b(),
        ...
        a = (function (t) {
            return t.slice().sort((t, e) => Kn(e) - Kn(t));
        })(n),
        o = (function (t) {
            return t.length
                ...
                return e
                    .map((e) =>
                        (function (e, { featured: n = !1 } = {}) {
                            ...
                            return `\n        <article class="review-card${n ? ' is-featured' : ''}" data-rating="${t(String(a))}">\n            <header>\n                <div class="review-card-heading">\n                    <span class="review-avatar">${t(Gn(e.name || 'Anonimo'))}</span>\n                    <div>\n                        <strong>${t(e.name || 'Anonimo')}</strong>\n                        <small>${t(i(e.date || e.createdAt || ''))}</small>\n                    </div>\n                </div>\n                <span class="review-rating-badge" data-tone="${t(o)}">${t(Qn(a))}</span>\n            </header>\n            <p>${t(Wn(e.comment || e.review || ''))}</p>\n            <small>${t(s)}</small>\n        </article>\n    `;
                        })(e, {
                            featured:
                                n.item &&
                                Un(e.name) === Un(n.item.name) &&
                                Kn(e) === Kn(n.item),
                        })
                    )
                    .join('');
    ...
    const e = await (async function () {
        try {
            const [t, e] = await Promise.all([
                ...
                })({ ...n, funnelMetrics: await xn(n) }, e, a);
            return (
                Bn(i),
                (function (t) {
                    (Me(Cn, t.appointments || []),
                        Me(qn, t.callbacks || []),
                        Me(An, t.reviews || []),
                        Me(Mn, t.availability || {}),
                        Me(Tn, t.availabilityMeta || {}),
                        Me($n, t.queueTickets || []),
                        Me(_n, t.queueMeta || null),
                        Me(Ln, t.health || null));
                })(i),
                !0
            );
    ...
    return (
        ...
        await (async function () {
            const t = Array.isArray(b().data.queueTickets)
                    ? b().data.queueTickets.map((t, e) => be(t, e))
                    : [],
                e = (function (t) {
                    return b().data.queueMeta &&
                        'object' == typeof b().data.queueMeta
                        ? ye(b().data.queueMeta, t)
                        : null;
                })(t);
            t.length
                ? Xe(t, e || null, { fallbackPartial: !1, syncMode: 'live' })
                : (function (t) {
                      const e = t ? Se(t) : [];
                      return (
                          !!e.length &&
                          ...
                          Je('Queue fallback parcial desde metadata'),
                          !0)
                      );
                  })(e) ||
                  (await rn(),
                  (b().data.queueTickets || []).length ||
                      sn(on(), 'Queue fallback desde snapshot local') ||
                      Xe([], null, { fallbackPartial: !1, syncMode: 'live' }));
        })(),
        H(b()),
        Vn(b()),
        rt(),
...
async function ta(t) {
    ...
    try {
        ...
        (x({
            ...
            F(b().auth.requires2FA ? '2fa' : 'password'),
            ...
            return (
                (function () {
                    ...
                    if (
                        ...
                        return;
                    const e = Ht(t.data.availability || {}),
                        n = jt(t.availability.selectedDate, e);
                    Yt(
                        {
                            draft: e,
...
const sa = 'themeMode',
    ra = new Set(['light', 'dark', 'system']);
const ca = 'adminLastSection',
...
function da() {
    const t = b();
    (qe(ca, t.ui.activeSection), qe(la, t.ui.sidebarCollapsed ? '1' : '0'));
}
function pa() {
...
function ya() {
    (fa((t) => ({ sidebarOpen: !t.sidebarOpen })), ba());
}
function va({ restoreFocus: t = !1 } = {}) {
    if ((fa(() => ({ sidebarOpen: !1 })), ba(), N(), t)) {
...
const Sa = {
    appointments_pending_transfer: async () => {
        (await ga('appointments'), lt('pending_transfer'), ut(''));
    },
    appointments_all: async () => {
        (await ga('appointments'), lt('all'), ut(''));
    },
    appointments_no_show: async () => {
        (await ga('appointments'), lt('no_show'), ut(''));
    },
    callbacks_pending: async () => {
        (await ga('callbacks'), Lt('pending'));
    },
    callbacks_contacted: async () => {
        (await ga('callbacks'), Lt('contacted'));
    },
    callbacks_sla_urgent: async () => {
        (await ga('callbacks'), Lt('sla_urgent'));
    },
    queue_sla_risk: async () => {
        (await ga('queue'), nn('sla_risk'));
    },
    queue_waiting: async () => {
        (await ga('queue'), nn('waiting'));
    },
    queue_called: async () => {
        (await ga('queue'), nn('called'));
    },
    queue_no_show: async () => {
        (await ga('queue'), nn('no_show'));
    },
    queue_all: async () => {
        (await ga('queue'), nn('all'));
    },
    queue_call_next: async () => {
        (await ga('queue'), await un(b().queue.stationConsultorio));
    },
};
async function Ca(t) {
    const e = Sa[t];
...
async function Aa(t, e) {
    switch (t) {
        ...
        case 'context-open-callbacks-pending':
            return (await ga('callbacks'), Lt('pending'), !0);
        default:
            return !1;
    }
}
async function Ma(t) {
    switch (t) {
        case 'context-open-appointments-transfer':
            return (await ga('appointments'), lt('pending_transfer'), !0);
        case 'context-open-dashboard':
            return (await ga('dashboard'), !0);
        default:
            return !1;
    }
}
async function Ta(t, e) {
    switch (t) {
        ...
        case 'queue-call-next':
            return (await un(Number(e.dataset.queueConsultorio || 0)), !0);
            ...
            return (
                await (async function (t) {
                    const e = 2 === Number(t || 0) ? 2 : 1,
                        n = je(e);
                    n
                        ? await dn(n.id, 'liberar', e)
                        : Je(`Sin ticket activo para liberar en C${e}`);
        ...
        case 'queue-toggle-ticket-select':
            return (
                (function (t) {
                    const e = Number(t || 0);
                    if (!e) return;
                    const n = He(b().queue.selected || []);
                    Ye(n.includes(e) ? n.filter((t) => t !== e) : [...n, e]);
                })(Number(e.dataset.queueId || 0)),
                !0
            );
        case 'queue-select-visible':
            return (Ye(Fe().map((t) => Number(t.id || 0))), !0);
        ...
        case 'queue-reprint-ticket':
            return (await gn(Number(e.dataset.queueId || 0)), !0);
            ...
            return (
                await (async function (t) {
                    ...
                    if (e.length) {
                        ...
                        (Ze(), Je(`Bulk ${n} sobre ${e.length} tickets`));
                    }
        ...
        case 'queue-bulk-reprint':
            return (
                await (async function () {
                    ...
                    (Ze(), Je(`Bulk reimpresion ${t.length}`));
                })(),
                !0
            );
        ...
        case 'queue-toggle-one-tap':
            return (en({ oneTap: !b().queue.oneTap }), !0);
        ...
        case 'queue-lock-station':
            return (
                (function (t) {
                    const e = 2 === Number(t || 0) ? 2 : 1;
                    (en({ stationMode: 'locked', stationConsultorio: e }),
                        Je(`Estacion bloqueada en C${e}`));
            ...
            return (
                (function (t) {
                    if ('free' === re(t))
                        return (
                            en({ stationMode: 'free' }),
                            void Je('Estacion en modo libre')
                        );
                    en({ stationMode: 'locked' });
        ...
        case 'queue-clear-call-key':
            return (
                window.confirm('¿Quitar tecla externa calibrada?') &&
                    (en({ customCallKey: null, captureCallKeyMode: !1 }),
...
async function _a() {
    (M(),
        ...
        document.addEventListener('click', (t) => {
            ...
            e &&
                (t.preventDefault(),
                nn(String(e.getAttribute('data-queue-filter') || 'all')));
        }),
        (function () {
        ...
        (function () {
            const t = {
                    stationMode:
                        'locked' === re(Ce($e, 'free')) ? 'locked' : 'free',
                    stationConsultorio: 2 === Number(Ce(_e, '1')) ? 2 : 1,
                    oneTap: '1' === Ce(Le, '0'),
                    helpOpen: '1' === Ce(Ne, '0'),
                    customCallKey: Ae(Ee, null),
                },
                e = re(Te('station')),
                n = re(Te('lock')),
                a = re(Te('one_tap'));
            (g((i) => ({
                ...
                queue: {
                    ...i.queue,
                    stationMode: wn(n, t.stationMode),
                    stationConsultorio: kn(e, t.stationConsultorio),
                    oneTap: Sn(a, t.oneTap),
                    helpOpen: t.helpOpen,
                    customCallKey:
        ...
        ua(
            (function () {
                const t = String(Ce(sa, 'system') || 'system')
                    .trim()
                    .toLowerCase();
                return ra.has(t) ? t : 'system';
            })()
        ),
        Xn(),
        (function () {
        ...
        (function () {
            ...
            (t?.addEventListener('click', () => {
                ...
                n?.addEventListener('click', () => va({ restoreFocus: !0 })),
                a?.addEventListener('click', () => va({ restoreFocus: !0 })),
                window.addEventListener('resize', () => {
                    pa() ? ba() : va();
                }),
                document.addEventListener('keydown', (t) => {
                    if (!pa() || !b().ui.sidebarOpen) return;
                    if ('Escape' === t.key)
                        return (
                            t.preventDefault(),
                            void va({ restoreFocus: !0 })
                        );
                    if ('Tab' !== t.key) return;
                    const n = (function () {
                        const t = e('#adminSidebar');
    ...
    (t instanceof HTMLFormElement && t.addEventListener('submit', ta),
        (function (t) {
            const {
                navigateToSection: e,
                focusQuickCommand: n,
            ...
            focusQuickCommand: ka,
            focusCurrentSearch: wa,
            runQuickAction: Ca,
            closeSidebar: () => va({ restoreFocus: !0 }),
            toggleMenu: () => {
                pa() ? ya() : ha();
            },
            dismissQueueSensitiveDialog: bn,
            toggleQueueHelp: () => fn(),
