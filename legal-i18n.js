(function () {
    ...
    const pages = {
        terms: {
            es: {
                page_title: "T\u00e9rminos y Condiciones | Piel en Armon\u00eda",
        ...
        privacy: {
            es: {
                page_title: "Pol\u00edtica de Privacidad | Piel en Armon\u00eda",
        ...
        medical: {
            es: {
                page_title: "Aviso de Responsabilidad M\u00e9dica | Piel en Armon\u00eda",
    ...
    const pageName = document.body && document.body.dataset ? document.body.dataset.legalPage : "";
