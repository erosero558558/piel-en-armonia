...
test('release-turnero-apps empaqueta bundle, publica APK y deja rutas de hosting listas', () => {
    ...
    for (const snippet of [
        ...
        'bundle_ready',
        'needs.resolve-release-plan.outputs.android_count',
        'needs.build-desktop.result',
        'needs.build-android.result',
        'needs.package-release-desktop-only.outputs.bundle_ready',
        'needs.package-release-full.outputs.bundle_ready',
        'No hay release bundle listo para publicar',
