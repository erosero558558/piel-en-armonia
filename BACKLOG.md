...
_Generado: 29/3/2026, 11:28:44 p. m. | Fuente: AGENTS.md_
...
- **S3-17** `[L]` → _antigravity_ (expira en 461min)
- **S3-36** `[S]` → _Codex-erosero558558_ (expira en 61min)
- **S3-56** `[M]` → _antigravity_ (expira en 222min)
