...
run_test('Standard service (consulta) - VAT 0% ($40.00)', function() {
    // consulta is 0% VAT in config.
    // 40.00 + 0 = 40.00
    $expected = '$40.00';
...
// Test 2: Service with VAT (laser) - VAT 15%
run_test('Service with VAT (laser) - VAT 15% ($172.50)', function() {
    // laser is 150.00 + 15% = 150 + 22.50 = 172.50
    $expected = '$172.50';
