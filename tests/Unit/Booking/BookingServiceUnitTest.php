...
namespace Tests\Unit\Booking {
    ...
    class BookingServiceUnitTest extends TestCase
    {
        ...
        public function testCreateWithCardPaymentSuccess(): void
        {
            ...
            PaymentMockRegistry::set('pi_card_success', [
                'status' => 'succeeded',
                'amount' => 4000,
                'currency' => 'usd',
        ...
        public function testCreateWithCardPaymentFailsStatus(): void
        {
            ...
            PaymentMockRegistry::set('pi_card_status_fail', [
        ...
        public function testCreateWithCardPaymentFailsAmount(): void
        {
            ...
            PaymentMockRegistry::set('pi_card_amount_fail', [
                'status' => 'succeeded',
                'amount' => 3000,
                'currency' => 'usd',
        ...
        public function testCreateWithCardPaymentFailsCurrency(): void
        {
            ...
            PaymentMockRegistry::set('pi_card_currency_fail', [
                'status' => 'succeeded',
                'amount' => 4000,
                'currency' => 'eur',
                'amount_received' => 4000,
        ...
        public function testCreateWithCardPaymentFailsMetadata(): void
        {
            ...
            PaymentMockRegistry::set('pi_card_metadata_fail', [
                'status' => 'succeeded',
                'amount' => 4000,
                'currency' => 'usd',
                'amount_received' => 4000,
...
namespace {
    use Tests\Unit\Booking\PaymentMockRegistry;
    ...
    if (!function_exists('stripe_get_payment_intent')) {
        ...
        {
            $mock = PaymentMockRegistry::get($id);
            if ($mock) {
                return $mock;
            }
            if ($id === 'pi_valid') {
            ...
            throw new \RuntimeException('Payment error: ' . $id);
        }
    }
