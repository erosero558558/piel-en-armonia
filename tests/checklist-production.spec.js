...
test.describe('Checklist de Pruebas en Producción', () => {
  ...
  test('2. Panel Admin - Login exitoso y navegacion', async ({ page, request }) => {
    ...
    // Esperar a que desaparezca el formulario de login o aparezca el dashboard
    // La clase 'is-hidden' en #adminDashboard debe ser removida
    ...
    for (const item of navItems) {
      ...
      const link = page.locator(`nav a, .nav-item, button`, { hasText: item }).first();
