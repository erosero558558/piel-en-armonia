...
function register_api_routes(Router $router): void
{
    ...
    $router->add('GET', 'config-audit-log', [ConfigAuditLogController::class, 'index']);
    ...
    $router->add('GET', 'patient-record-pdf', [PatientPortalController::class, 'historyPdf']);
    ...
    $router->add('POST', 'consent-status', [ConsentStatusController::class, 'process']);
