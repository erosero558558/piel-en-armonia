...
public function  buildFinalNoteContent(array $session, array $draft): string
    {
        ...
        $parts = [
            ...
            'Antecedentes personales: ' . ClinicalHistoryRepository::trimString($intake['antecedentesPersonales'] ?? ''),
            'Antecedentes familiares: ' . ClinicalHistoryRepository::trimString($intake['antecedentesFamiliares'] ?? ''),
            'Alergias: ' . ClinicalHistoryRepository::trimString($intake['alergias'] ?? ''),
            'Medicacion actual: ' . ClinicalHistoryRepository::trimString($intake['medicacionActual'] ?? ''),
            'Fototipo Fitzpatrick: ' . ClinicalHistoryRepository::trimString($intake['fototipoFitzpatrick'] ?? ''),
            'Habitos de sol: ' . ClinicalHistoryRepository::trimString($intake['habitosSol'] ?? ''),
            'Habitos de tabaco: ' . ClinicalHistoryRepository::trimString($intake['habitosTabaco'] ?? ''),
