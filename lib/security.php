...
function apply_security_headers(bool $isHtml = false): void
{
    ...
    if ($isHtml) {
        ...
        $csp .= "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://cdnjs.cloudflare.com https://www.googletagmanager.com https://www.google-analytics.com https://browser.sentry-cdn.com https://static.cloudflareinsights.com; ";
