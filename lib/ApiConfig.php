...
class ApiConfig
{
    public static function getRateLimits(): array
    {
        return [
            ...
            'patient-portal-history-pdf:GET' => [30, 60],
            ...
            'consent-status:POST' => [15, 60],
            'patient-portal-submit-survey:POST' => [12, 600],
            'telemedicine-preconsultation:POST' => [8, 300],
            'telemedicine-recording-consent:POST' => [12, 300],
    ...
    public static function getPublicEndpoints(): array
    {
        return [
            ...
            ['method' => 'GET', 'resource' => 'clinic-profile'],
            ...
            ['method' => 'GET', 'resource' => 'queue-public-ticket'],
            ...
            ['method' => 'POST', 'resource' => 'patient-portal-submit-survey'],
            ...
            ['method' => 'GET', 'resource' => 'patient-portal-history-pdf'],
            ...
            ['method' => 'GET', 'resource' => 'consent-status'],
            ['method' => 'POST', 'resource' => 'consent-status'],
