    ...
    return {
        ...
        defaults: {
            ...
            updateBasePath:
                ...
                '/desktop-updates/',
            brandName:
                normalizeString(registry.defaults.brandName) ||
                'Consultorio Medicina General',
            brandShortName:
                normalizeString(registry.defaults.brandShortName) ||
                'Medicina General',
            surfaceTitles: normalizeStringMap(registry.defaults.surfaceTitles),
            downloadLabels: normalizeStringMap(
                registry.defaults.downloadLabels
            ),
        },
