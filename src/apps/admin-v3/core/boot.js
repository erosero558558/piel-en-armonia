import { attachKeyboardShortcuts } from '../../admin-v2/core/keyboard.js';
import {
    readThemeMode,
    persistThemeMode,
    applyTheme,
} from '../../admin-v2/core/flags.js';
import {
    getStorageItem,
    setStorageItem,
} from '../../admin-v2/core/persistence.js';
import {
    normalizeSection,
    readSectionFromHash,
    setSectionHash,
} from '../../admin-v2/core/router.js';
import { getState, updateState } from '../../admin-v2/core/store.js';
import { createToast, qs, setText } from '../../admin-v2/ui/render.js';
import {
    checkAuthStatus,
    loginWith2FA,
    loginWithPassword,
    logoutSession,
} from '../../admin-v2/modules/auth.js';
import {
    renderV3Frame,
    showCommandPalette,
    hideCommandPalette,
