...
const STORAGE_KEY = 'turneroSurfaceCommercialOwnerStoreV1';
const STORAGE_SCHEMA = 'turnero-surface-commercial-owner-store/v1';
...
function normalizeEntry(entry = {}, fallbackScope = 'global') {
    ...
    return {
        ...
        role: toString(source.role, 'commercial'),
...
export function createTurneroSurfaceCommercialOwnerStore(
    scope = 'global',
    clinicProfile = null
) {
    const normalizedScope = toString(scope, 'global') || 'global';
