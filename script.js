...
var successModal = /*#__PURE__*/Object.freeze({
    __proto__: null,
    closeSuccessModal: closeSuccessModal,
    initSuccessModalEngineWarmup: initSuccessModalEngineWarmup,
    loadSuccessModalEngine: loadSuccessModalEngine,
...
var ui = /*#__PURE__*/Object.freeze({
    ...
    initModalUxEngineWarmup: initModalUxEngineWarmup,
    initUiEffectsWarmup: initUiEffectsWarmup,
    loadModalUxEngine: loadModalUxEngine,
    loadUiEffects: loadUiEffects,
    startWebVideo: startWebVideo,
...
var reschedule = /*#__PURE__*/Object.freeze({
    __proto__: null,
    closeRescheduleModal: closeRescheduleModal,
    initRescheduleEngineWarmup: initRescheduleEngineWarmup,
    loadRescheduleEngine: loadRescheduleEngine,
...
var shell = /*#__PURE__*/Object.freeze({
    ...
    checkServerEnvironment: checkServerEnvironment,
    escapeHtml: escapeHtml,
    finalizeChatBooking: finalizeChatBooking,
    handleChatBookingSelection: handleChatBookingSelection,
    handleChatDateSelect: handleChatDateSelect,
    handleChatKeypress: handleChatKeypress,
    initChatBookingEngineWarmup: initChatBookingEngineWarmup,
    initChatEngineWarmup: initChatEngineWarmup,
    initChatUiEngineWarmup: initChatUiEngineWarmup,
    initChatWidgetEngineWarmup: initChatWidgetEngineWarmup,
    isChatBookingActive: isChatBookingActive,
    loadChatBookingEngine: loadChatBookingEngine,
    loadChatUiEngine: loadChatUiEngine,
    loadChatWidgetEngine: loadChatWidgetEngine,
    loadFigoChatEngine: loadFigoChatEngine,
    minimizeChatbot: minimizeChatbot,
    processChatBookingStep: processChatBookingStep,
    processWithKimi: processWithKimi,
    removeTypingIndicator: removeTypingIndicator,
    scheduleChatNotification: scheduleChatNotification,
    scrollToBottom: scrollToBottom,
    sendChatMessage: sendChatMessage,
    sendQuickMessage: sendQuickMessage,
    showTypingIndicator: showTypingIndicator,
    startChatBooking: startChatBooking,
...
function initChatActionFallbackBridge() {
    ...
    document.addEventListener('click', async function (event) {
        ...
        if (['toggle-chatbot', 'minimize-chat', 'send-chat-message', 'quick-message', 'chat-booking', 'start-booking'].includes(action)) {
            ...
            const chatShell = await Promise.resolve().then(function () { return shell; });
    ...
    document.addEventListener('change', async function (event) {
        ...
        if (target.closest('[data-action="chat-date-select"]')) {
            const { handleChatDateSelect } = await Promise.resolve().then(function () { return shell; });
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    loadDeferredContent().then(() => {
        ...
        const initHighPriorityWarmups = createOnceTask(async () => {
            ...
            const { initChatUiEngineWarmup, initChatWidgetEngineWarmup } = await Promise.resolve().then(function () { return shell; });
        ...
        const initLowPriorityWarmups = createOnceTask(async () => {
            const [
                ...
                Promise.resolve().then(function () { return engagement; }),
                import('./js/chunks/gallery-D7rQHo0K.js'),
                Promise.resolve().then(function () { return shell; }),
                Promise.resolve().then(function () { return ui; }),
                Promise.resolve().then(function () { return reschedule; }),
                Promise.resolve().then(function () { return successModal; })
            ]);
        ...
        if (chatInput) {
            Promise.resolve().then(function () { return shell; }).then(({ handleChatKeypress }) => {
    ...
    Promise.resolve().then(function () { return shell; }).then(({ checkServerEnvironment }) => {
...
export { createWarmupRunner as c, loadDeferredModule as l, observeOnceWhenVisible as o, scheduleDeferredTask as s, withDeployAssetVersion as w };
