window.PIEL_EN_TRANSLATIONS = {
        ...
        callback_desc: "We will contact you shortly (during business hours).",
        ...
        team_title: "Our Team",
        team_subtitle_new: "Evidence-based care, with a clinical and aesthetic focus.",
        rosero_role_exp: "Clinical Dermatologist · 15 years experience",
        rosero_focus_list: "acne, spots, dermatitis, skin cancer, dermatologic surgery.",
        rosero_modality_list: "in-person and online",
        narvaez_role_exp: "Aesthetic Dermatologist · Rejuvenation Specialist",
        narvaez_focus_list: "facial rejuvenation, laser, medical aesthetics, non-invasive treatments.",
        narvaez_modality_list: "in-person and online",
        label_focus: "Focus:",
        label_modality: "Modality:",
        btn_book_rosero: "Book with Dr. Rosero",
        btn_book_narvaez: "Book with Dr. Narváez",
        btn_whatsapp_short: "WhatsApp",
        btn_email_short: "Email",
        ...
        summary_iva: "VAT (12%)",
        summary_total: "Total",
        price_hint: "Select a service to calculate the total.",
