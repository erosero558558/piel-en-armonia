window.PIEL_EN_TRANSLATIONS = {
        ...
        theme_dark: "Dark",
        theme_system: "System",
        hero_title1: "Clinical and aesthetic dermatology in Quito,",
        hero_title2: "with a medical focus",
        hero_subtitle: "We evaluate your case, define the diagnosis, and give you a clear plan. In-person or online.",
        hero_cta_primary: "Book Consultation",
        hero_cta_secondary: "Online Consultation Today",
        hero_bullet1: "Diagnosis and plan (no 'generic' treatments)",
        hero_bullet2: "Teledermatology with photo guide",
        hero_bullet3: "Easy follow-up and rescheduling",
        ...
        pathologies_title: "Frequent Pathologies",
        path_acne: "Acne and scars",
        path_rosacea: "Rosacea and redness",
        path_melasma: "Melasma and spots",
        path_hair: "Hair loss",
        path_nails: "Nail fungus",
        path_warts: "Warts and moles",
        path_dermatitis: "Dermatitis and allergies",
        path_kids: "Pediatric dermatology",
        path_aging: "Aging signs",
        traj_title: "Trajectory and Recognitions",
        traj_subtitle: "Constant commitment to academic excellence and scientific dissemination.",
        traj_card1_title: "Media Appearances",
        traj_card1_desc: "Frequent guest experts on TV and Radio to discuss skin health.",
        traj_card2_title: "International Congresses",
        traj_card2_desc: "Speakers at dermatological events in Latin America and USA.",
        traj_card3_title: "Scientific Publications",
        traj_card3_desc: "Authors of articles in indexed dermatology journals.",
        tips_title: "Expert Tips",
        tips_subtitle: "Small changes for big results on your skin.",
        tip1_title: "Sun Protection 365",
        tip1_desc: "The sun is the #1 cause of aging. Use SPF 50+ sunscreen every 3 hours, even on cloudy days.",
        tip2_title: "The ABCDE Rule",
        tip2_desc: "Watch your moles: Asymmetry, Borders, Color, Diameter, and Evolution. If in doubt, consult.",
        tip3_title: "Hydration is Key",
        tip3_desc: "Hydrated skin is strong skin. Drink water and use moisturizer according to your skin type.",
